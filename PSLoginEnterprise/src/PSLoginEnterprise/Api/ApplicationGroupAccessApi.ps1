...
None
#>
function Invoke-ConfigurationBulkAddApplicationGroupAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkAddApplicationGroupAccess' | Write-Debug
...
None
#>
function Invoke-ConfigurationBulkRemoveApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkRemoveApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-ConfigurationBulkReplaceApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkReplaceApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String[]
#>
function Invoke-ConfigurationGetApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$ApplicationGroupId) {
            throw "Error! The required parameter `ApplicationGroupId` missing when calling configurationGetApplicationGroupAccess."
        }
...
String[]
#>
function Invoke-ConfigurationGetApplicationGroupsByRole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetApplicationGroupsByRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-ConfigurationUpdateApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationUpdateApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/application-groups/{applicationGroupId}/access'
        if (!$ApplicationGroupId) {
            throw "Error! The required parameter `ApplicationGroupId` missing when calling configurationUpdateApplicationGroupAccess."
        }
        $LocalVarUri = $LocalVarUri.replace('{applicationGroupId}', [System.Web.HTTPUtility]::UrlEncode($ApplicationGroupId))
