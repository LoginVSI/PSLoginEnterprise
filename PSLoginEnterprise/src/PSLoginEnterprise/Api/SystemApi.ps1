...
SystemEuxVersion
#>
function Invoke-DataGetSystemEuxVersion {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataGetSystemEuxVersion' | Write-Debug
        ...
        $LocalVarUri = '/v7/system/eux-version'
...
SystemVersionResult
#>
function Invoke-DataGetSystemVersions {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataGetSystemVersions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "SystemVersionResult" `
                                -IsBodyNullable $false
