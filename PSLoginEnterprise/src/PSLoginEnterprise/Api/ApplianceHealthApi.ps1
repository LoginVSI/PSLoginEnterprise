...
#>
function Invoke-DataGetApplianceHealthAlertSettingsAsync {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataGetApplianceHealthAlertSettingsAsync' | Write-Debug
...
#>
function Invoke-DataGetApplianceHealthMetricsAsync {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataGetApplianceHealthMetricsAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-DataUpdateApplianceHealthAlertSettingsAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-DataUpdateApplianceHealthAlertSettingsAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
