...
ConnectionResources
#>
function Invoke-ConfigurationGetConnectionResources {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetConnectionResources' | Write-Debug
        ...
        $LocalVarUri = '/v7/tests/{testId}/connection-resources'
        if (!$TestId) {
            throw "Error! The required parameter `TestId` missing when calling configurationGetConnectionResources."
        }
...
None
#>
function Invoke-ConfigurationUpdateConnectionResources {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationUpdateConnectionResources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/tests/{testId}/connection-resources'
        if (!$TestId) {
            throw "Error! The required parameter `TestId` missing when calling configurationUpdateConnectionResources."
        }
        $LocalVarUri = $LocalVarUri.replace('{testId}', [System.Web.HTTPUtility]::UrlEncode($TestId))

        if (!$ConnectionResourcesUpdate) {
            throw "Error! The required parameter `ConnectionResourcesUpdate` missing when calling configurationUpdateConnectionResources."
        }
