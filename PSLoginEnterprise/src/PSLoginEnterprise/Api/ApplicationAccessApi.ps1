...
None
#>
function Invoke-ConfigurationBulkAddApplicationAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkAddApplicationAccess' | Write-Debug
...
None
#>
function Invoke-ConfigurationBulkRemoveApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkRemoveApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-ConfigurationBulkReplaceApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkReplaceApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String[]
#>
function Invoke-ConfigurationGetApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$ApplicationId) {
            throw "Error! The required parameter `ApplicationId` missing when calling configurationGetApplicationAccess."
        }
...
String[]
#>
function Invoke-ConfigurationGetApplicationsByRole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetApplicationsByRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-ConfigurationUpdateApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationUpdateApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/applications/{applicationId}/access'
        if (!$ApplicationId) {
            throw "Error! The required parameter `ApplicationId` missing when calling configurationUpdateApplicationAccess."
        }
        $LocalVarUri = $LocalVarUri.replace('{applicationId}', [System.Web.HTTPUtility]::UrlEncode($ApplicationId))
