...
ObjectId
#>
function Invoke-DataCreateUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataCreateUser' | Write-Debug
...
None
#>
function Invoke-DataDeleteUser {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataDeleteUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$UserId) {
            throw "Error! The required parameter `UserId` missing when calling dataDeleteUser."
        }
...
UserResultSet
#>
function Invoke-DataGetAllUsers {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetAllUsers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
User
#>
function Invoke-DataGetUserById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetUserById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/users/{userId}'
        if (!$UserId) {
            throw "Error! The required parameter `UserId` missing when calling dataGetUserById."
        }
        $LocalVarUri = $LocalVarUri.replace('{userId}', [System.Web.HTTPUtility]::UrlEncode($UserId))
...
None
#>
function Invoke-DataUpdateUser {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataUpdateUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/users/{userId}'
        if (!$UserId) {
            throw "Error! The required parameter `UserId` missing when calling dataUpdateUser."
        }
        $LocalVarUri = $LocalVarUri.replace('{userId}', [System.Web.HTTPUtility]::UrlEncode($UserId))
