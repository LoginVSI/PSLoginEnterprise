...
EuxSettings
#>
function Invoke-ConfigurationGetEuxSettings {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetEuxSettings' | Write-Debug
...
None
#>
function Invoke-ConfigurationUpdateEuxSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConfigurationUpdateEuxSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$EuxSettings) {
            throw "Error! The required parameter `EuxSettings` missing when calling configurationUpdateEuxSettings."
        }
