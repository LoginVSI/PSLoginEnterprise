...
System.IO.FileInfo
#>
function Invoke-DataDownloadContinuousTestReport {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataDownloadContinuousTestReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$ReportId) {
            throw "Error! The required parameter `ReportId` missing when calling dataDownloadContinuousTestReport."
        }
...
System.IO.FileInfo
#>
function Invoke-DataDownloadLoadTestPdfReport {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String[]]
    ...
    Process {
        'Calling method: Invoke-DataDownloadLoadTestPdfReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$TestRunIds) {
            throw "Error! The required parameter `TestRunIds` missing when calling dataDownloadLoadTestPdfReport."
        }
...
DataGetApplicationTestReport200Response
#>
function Invoke-DataGetContinuousTestReport {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetContinuousTestReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$ReportId) {
            throw "Error! The required parameter `ReportId` missing when calling dataGetContinuousTestReport."
        }
        $LocalVarUri = $LocalVarUri.replace('{reportId}', [System.Web.HTTPUtility]::UrlEncode($ReportId))
