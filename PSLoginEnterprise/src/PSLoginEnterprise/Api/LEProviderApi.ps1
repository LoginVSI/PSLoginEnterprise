...
function New-LEProvider {
    ...
    Process {
        ...
        if (!$ProviderAzureData) {
            throw "Error! The required parameter `ProviderAzureData` missing when calling createProvider."
        }
...
function Test-LEProviderConnection {
    ...
    Process {
        ...
        if (!$TestAzureConnectionData) {
            throw "Error! The required parameter `TestAzureConnectionData` missing when calling testProviderConnection."
        }
...
function Update-LEProvider {
    ...
    Process {
        ...
        if (!$ProviderAzureData) {
            throw "Error! The required parameter `ProviderAzureData` missing when calling updateProvider."
        }
