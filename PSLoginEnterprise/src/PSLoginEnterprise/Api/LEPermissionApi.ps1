...
function Get-LEAllPermissions {
    ...
    Process {
        'Calling method: Get-LEAllPermissions' | Write-Debug
...
String[]
#>
function Get-LEPermissionsForCallingUser {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-LEPermissionsForCallingUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
