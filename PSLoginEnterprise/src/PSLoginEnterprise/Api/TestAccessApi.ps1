...
None
#>
function Invoke-ConfigurationBulkAddTestAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkAddTestAccess' | Write-Debug
...
None
#>
function Invoke-ConfigurationBulkReplaceTestAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ConfigurationBulkReplaceTestAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String[]
#>
function Invoke-ConfigurationGetTestAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetTestAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$TestId) {
            throw "Error! The required parameter `TestId` missing when calling configurationGetTestAccess."
        }
...
String[]
#>
function Invoke-ConfigurationGetTestsByRole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetTestsByRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-ConfigurationUpdateTestAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationUpdateTestAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/tests/{testId}/access'
        if (!$TestId) {
            throw "Error! The required parameter `TestId` missing when calling configurationUpdateTestAccess."
        }
        $LocalVarUri = $LocalVarUri.replace('{testId}', [System.Web.HTTPUtility]::UrlEncode($TestId))
