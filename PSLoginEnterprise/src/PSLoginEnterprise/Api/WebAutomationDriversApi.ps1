...
#>
function Invoke-DataCheckUpdateDriverVersions {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataCheckUpdateDriverVersions' | Write-Debug
        ...
        $LocalVarUri = '/v7/web-automation-drivers/status'
...
None
#>
function Invoke-DataConfigureAutomaticWebDriverUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataConfigureAutomaticWebDriverUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/web-automation-drivers/automatic-update/configure'

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling dataConfigureAutomaticWebDriverUpdate."
        }
...
#>
function Invoke-DataDownloadLatestWebAutomationDrivers {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataDownloadLatestWebAutomationDrivers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/web-automation-drivers/download'
...
WebDriverUpdateInfo
#>
function Invoke-DataGetWebDriverUpdateInfo {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataGetWebDriverUpdateInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
