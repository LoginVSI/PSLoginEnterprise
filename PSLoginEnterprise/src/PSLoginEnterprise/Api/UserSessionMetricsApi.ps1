...
#>
function Invoke-DataGetUserSessionMetrics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataGetUserSessionMetrics' | Write-Debug
        ...
        $LocalVarUri = '/v7/user-session-metrics/{testRunId}'
        if (!$TestRunId) {
            throw "Error! The required parameter `TestRunId` missing when calling dataGetUserSessionMetrics."
        }
