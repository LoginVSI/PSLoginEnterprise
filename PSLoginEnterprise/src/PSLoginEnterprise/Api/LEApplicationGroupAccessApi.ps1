...
.PARAMETER ApplicationGroupAccessBulkUpdate
The update request
...
None
#>
function Invoke-LEBulkAddApplicationGroupAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-LEBulkAddApplicationGroupAccess' | Write-Debug
        ...
        $LocalVarUri = '/v7/application-groups/access'

        $LocalVarBodyParameter = $ApplicationGroupAccessBulkUpdate | ConvertTo-Json -Depth 100
...
None
#>
function Invoke-LEBulkRemoveApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-LEBulkRemoveApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-LEBulkReplaceApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-LEBulkReplaceApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String[]
#>
function Get-LEApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-LEApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/application-groups/{applicationGroupId}/access'
        if (!$ApplicationGroupId) {
            throw "Error! The required parameter `ApplicationGroupId` missing when calling getApplicationGroupAccess."
        }
        $LocalVarUri = $LocalVarUri.replace('{applicationGroupId}', [System.Web.HTTPUtility]::UrlEncode($ApplicationGroupId))
...
.PARAMETER RoleId
The ID of the role used to filter application groups. Empty when fetching application groups without assigned roles
...
.PARAMETER Filter
Filter on Application Group Name and Description
...
String[]
#>
function Get-LEApplicationGroupsByRole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-LEApplicationGroupsByRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/application-groups/role'

        $LocalVarQueryParameters['roleId'] = $RoleId

        if (!$OrderBy) {
            throw "Error! The required parameter `OrderBy` missing when calling getApplicationGroupsByRole."
        }
        $LocalVarQueryParameters['orderBy'] = $OrderBy

        if (!$Direction) {
            throw "Error! The required parameter `Direction` missing when calling getApplicationGroupsByRole."
        }
        $LocalVarQueryParameters['direction'] = $Direction

        if (!$Count) {
            throw "Error! The required parameter `Count` missing when calling getApplicationGroupsByRole."
        }
...
The IDs of the roles to which this application group should be available.
...
None
#>
function Update-LEApplicationGroupAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-LEApplicationGroupAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/application-groups/{applicationGroupId}/access'
        if (!$ApplicationGroupId) {
            throw "Error! The required parameter `ApplicationGroupId` missing when calling updateApplicationGroupAccess."
        }
        $LocalVarUri = $LocalVarUri.replace('{applicationGroupId}', [System.Web.HTTPUtility]::UrlEncode($ApplicationGroupId))
