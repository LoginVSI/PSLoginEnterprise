...
ObjectId
#>
function Invoke-DataCreateLdapGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataCreateLdapGroup' | Write-Debug
...
None
#>
function Invoke-DataDeleteLdapGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataDeleteLdapGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$LdapGroupId) {
            throw "Error! The required parameter `LdapGroupId` missing when calling dataDeleteLdapGroup."
        }
...
LdapGroupResultSet
#>
function Invoke-DataGetAllLdapGroups {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetAllLdapGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LdapGroup
#>
function Invoke-DataGetLdapGroupById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetLdapGroupById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/ldap-groups/{ldapGroupId}'
        if (!$LdapGroupId) {
            throw "Error! The required parameter `LdapGroupId` missing when calling dataGetLdapGroupById."
        }
        $LocalVarUri = $LocalVarUri.replace('{ldapGroupId}', [System.Web.HTTPUtility]::UrlEncode($LdapGroupId))
...
None
#>
function Invoke-DataUpdateLdapGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataUpdateLdapGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/ldap-groups/{ldapGroupId}'
        if (!$LdapGroupId) {
            throw "Error! The required parameter `LdapGroupId` missing when calling dataUpdateLdapGroup."
        }
        $LocalVarUri = $LocalVarUri.replace('{ldapGroupId}', [System.Web.HTTPUtility]::UrlEncode($LdapGroupId))
