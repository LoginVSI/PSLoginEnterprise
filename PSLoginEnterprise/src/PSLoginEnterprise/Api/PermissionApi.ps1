...
String[]
#>
function Invoke-DataGetAllPermissions {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataGetAllPermissions' | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/permissions'
...
String[]
#>
function Invoke-DataGetPermissionsForCallingUser {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataGetPermissionsForCallingUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/permissions/self'
