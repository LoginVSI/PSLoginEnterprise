...
#>
function Invoke-DataGetMeasurements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataGetMeasurements' | Write-Debug
        ...
        $LocalVarUri = '/v7/test-runs/{testRunId}/measurements'
        if (!$TestRunId) {
            throw "Error! The required parameter `TestRunId` missing when calling dataGetMeasurements."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "MeasurementResultSet" `
...
MeasurementResultSet
#>
function Invoke-DataGetMeasurementsByAppExecution {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetMeasurementsByAppExecution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/test-runs/{testRunId}/app-executions/{appExecutionId}/measurements'
        if (!$TestRunId) {
            throw "Error! The required parameter `TestRunId` missing when calling dataGetMeasurementsByAppExecution."
        }
        $LocalVarUri = $LocalVarUri.replace('{testRunId}', [System.Web.HTTPUtility]::UrlEncode($TestRunId))
        if (!$AppExecutionId) {
            throw "Error! The required parameter `AppExecutionId` missing when calling dataGetMeasurementsByAppExecution."
        }
...
MeasurementResultSet
#>
function Invoke-DataGetMeasurementsByUserSession {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetMeasurementsByUserSession' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/test-runs/{testRunId}/user-sessions/{userSessionId}/measurements'
        if (!$TestRunId) {
            throw "Error! The required parameter `TestRunId` missing when calling dataGetMeasurementsByUserSession."
        }
        $LocalVarUri = $LocalVarUri.replace('{testRunId}', [System.Web.HTTPUtility]::UrlEncode($TestRunId))
        if (!$UserSessionId) {
            throw "Error! The required parameter `UserSessionId` missing when calling dataGetMeasurementsByUserSession."
        }
