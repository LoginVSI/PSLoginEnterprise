...
ObjectId
#>
function Invoke-DataCreateProvider {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataCreateProvider' | Write-Debug
        ...
        $LocalVarUri = '/v7/providers'

        if (!$ProviderAzureData) {
            throw "Error! The required parameter `ProviderAzureData` missing when calling dataCreateProvider."
        }

        $LocalVarBodyParameter = $ProviderAzureData | ConvertTo-Json -Depth 100
...
None
#>
function Invoke-DataDeleteProvider {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataDeleteProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/providers/{providerId}'
        if (!$ProviderId) {
            throw "Error! The required parameter `ProviderId` missing when calling dataDeleteProvider."
        }
...
ProviderAzure
#>
function Invoke-DataGetProviderById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetProviderById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/providers/{providerId}'
        if (!$ProviderId) {
            throw "Error! The required parameter `ProviderId` missing when calling dataGetProviderById."
        }
        $LocalVarUri = $LocalVarUri.replace('{providerId}', [System.Web.HTTPUtility]::UrlEncode($ProviderId))
...
ProviderResultSet
#>
function Invoke-DataGetProviders {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetProviders' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
.PARAMETER TestAzureConnectionData
Test Provider Connection
...
#>
function Invoke-DataTestProviderConnection {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-DataTestProviderConnection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/providers/test-connection'

        if (!$TestAzureConnectionData) {
            throw "Error! The required parameter `TestAzureConnectionData` missing when calling dataTestProviderConnection."
        }

        $LocalVarBodyParameter = $TestAzureConnectionData | ConvertTo-Json -Depth 100
...
None
#>
function Invoke-DataUpdateProvider {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataUpdateProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/providers/{providerId}'
        if (!$ProviderId) {
            throw "Error! The required parameter `ProviderId` missing when calling dataUpdateProvider."
        }
        $LocalVarUri = $LocalVarUri.replace('{providerId}', [System.Web.HTTPUtility]::UrlEncode($ProviderId))

        if (!$ProviderAzureData) {
            throw "Error! The required parameter `ProviderAzureData` missing when calling dataUpdateProvider."
        }
