...
.PARAMETER ApplicationAccessBulkUpdate
The update request
...
None
#>
function Invoke-LEBulkAddApplicationAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-LEBulkAddApplicationAccess' | Write-Debug
        ...
        $LocalVarUri = '/v7/applications/access'

        $LocalVarBodyParameter = $ApplicationAccessBulkUpdate | ConvertTo-Json -Depth 100
...
None
#>
function Invoke-LEBulkRemoveApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-LEBulkRemoveApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-LEBulkReplaceApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-LEBulkReplaceApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String[]
#>
function Get-LEApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-LEApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/applications/{applicationId}/access'
        if (!$ApplicationId) {
            throw "Error! The required parameter `ApplicationId` missing when calling getApplicationAccess."
        }
...
.PARAMETER RoleId
The ID of the role used to filter applications. Empty when fetching applications without assigned roles
...
.PARAMETER Filter
Filter on Application Name and Description
...
String[]
#>
function Get-LEApplicationsByRole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-LEApplicationsByRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/applications/role'

        $LocalVarQueryParameters['roleId'] = $RoleId

        if (!$OrderBy) {
            throw "Error! The required parameter `OrderBy` missing when calling getApplicationsByRole."
        }
        $LocalVarQueryParameters['orderBy'] = $OrderBy

        if (!$Direction) {
            throw "Error! The required parameter `Direction` missing when calling getApplicationsByRole."
        }
        $LocalVarQueryParameters['direction'] = $Direction

        if (!$Count) {
            throw "Error! The required parameter `Count` missing when calling getApplicationsByRole."
        }
...
The IDs of the roles to which this application should be available.
...
None
#>
function Update-LEApplicationAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-LEApplicationAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/applications/{applicationId}/access'
        if (!$ApplicationId) {
            throw "Error! The required parameter `ApplicationId` missing when calling updateApplicationAccess."
        }
        $LocalVarUri = $LocalVarUri.replace('{applicationId}', [System.Web.HTTPUtility]::UrlEncode($ApplicationId))
