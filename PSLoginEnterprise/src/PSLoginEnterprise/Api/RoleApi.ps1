...
ObjectId
#>
function Invoke-DataCreateRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DataCreateRole' | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/roles'

        $LocalVarBodyParameter = $RoleCreate | ConvertTo-Json -Depth 100
...
None
#>
function Invoke-DataDeleteRole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataDeleteRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/roles/{roleId}'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling dataDeleteRole."
        }
...
RoleResultSet
#>
function Invoke-DataGetAllRoles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetAllRoles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Role
#>
function Invoke-DataGetRoleById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataGetRoleById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/roles/{roleId}'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling dataGetRoleById."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
...
#>
function Invoke-DataGetRolesForCallingUser {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DataGetRolesForCallingUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/roles/self'
...
None
#>
function Invoke-DataUpdateRole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DataUpdateRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/roles/{roleId}'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling dataUpdateRole."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))

        $LocalVarBodyParameter = $RoleUpdate | ConvertTo-Json -Depth 100
