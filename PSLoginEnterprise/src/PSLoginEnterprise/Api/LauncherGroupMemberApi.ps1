...
None
#>
function Invoke-ConfigurationAddLauncherGroupMembers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ConfigurationAddLauncherGroupMembers' | Write-Debug
        ...
        $LocalVarUri = '/v7/launcher-groups/{groupId}/members'
        if (!$GroupId) {
            throw "Error! The required parameter `GroupId` missing when calling configurationAddLauncherGroupMembers."
        }
        $LocalVarUri = $LocalVarUri.replace('{groupId}', [System.Web.HTTPUtility]::UrlEncode($GroupId))

        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling configurationAddLauncherGroupMembers."
        }
...
LauncherResultSet
#>
function Invoke-ConfigurationGetLauncherGroupMembers {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationGetLauncherGroupMembers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/launcher-groups/{groupId}/members'
        if (!$GroupId) {
            throw "Error! The required parameter `GroupId` missing when calling configurationGetLauncherGroupMembers."
        }
        $LocalVarUri = $LocalVarUri.replace('{groupId}', [System.Web.HTTPUtility]::UrlEncode($GroupId))
...
None
#>
function Invoke-ConfigurationRemoveLauncherGroupMembers {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ConfigurationRemoveLauncherGroupMembers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/launcher-groups/{groupId}/members'
        if (!$GroupId) {
            throw "Error! The required parameter `GroupId` missing when calling configurationRemoveLauncherGroupMembers."
        }
        $LocalVarUri = $LocalVarUri.replace('{groupId}', [System.Web.HTTPUtility]::UrlEncode($GroupId))

        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling configurationRemoveLauncherGroupMembers."
        }
