...
function Initialize-LELEPerformanceResults {
    [CmdletBinding()]
    Param (
...
Convert from JSON to PerformanceResults<PSCustomObject>
...
function ConvertFrom-LEJsonToPerformanceResults {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "euxState"))) { #optional property not found
            $EuxState = $null
        } else {
            $EuxState = $JsonParameters.PSobject.Properties["euxState"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "vsiMaxState"))) { #optional property not found
            $VsiMaxState = $null
        } else {
            $VsiMaxState = $JsonParameters.PSobject.Properties["vsiMaxState"].value
        }
