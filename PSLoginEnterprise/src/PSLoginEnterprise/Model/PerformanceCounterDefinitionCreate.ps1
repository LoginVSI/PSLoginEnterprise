...
Performance counter definition creation data
...
function Initialize-LELEPerformanceCounterDefinitionCreate {
    [CmdletBinding()]
    Param (
...
Convert from JSON to PerformanceCounterDefinitionCreate<PSCustomObject>
