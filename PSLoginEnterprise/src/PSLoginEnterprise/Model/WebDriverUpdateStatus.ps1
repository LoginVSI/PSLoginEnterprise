...
Web Driver Update Status

.PARAMETER UpdatesAvailable
Determines whether Updates Available for any of the Web Automation Driver Flavors
.PARAMETER Drivers
Drivers Statuses
.OUTPUTS
...
function Initialize-LELEWebDriverUpdateStatus {
    [CmdletBinding()]
    Param (
...
Convert from JSON to WebDriverUpdateStatus<PSCustomObject>
...
function ConvertFrom-LEJsonToWebDriverUpdateStatus {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "drivers"))) { #optional property not found
            $Drivers = $null
        } else {
            $Drivers = $JsonParameters.PSobject.Properties["drivers"].value
        }
