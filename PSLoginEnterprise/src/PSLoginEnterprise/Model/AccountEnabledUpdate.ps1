...
Account enable/disable data

.PARAMETER AccountIds
Accounts to be enabled/disabled
.PARAMETER Enabled
...
function Initialize-LELEAccountEnabledUpdate {
    [CmdletBinding()]
    Param (
...
Convert from JSON to AccountEnabledUpdate<PSCustomObject>
...
function ConvertFrom-LEJsonToAccountEnabledUpdate {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "accountIds"))) { #optional property not found
            $AccountIds = $null
        } else {
