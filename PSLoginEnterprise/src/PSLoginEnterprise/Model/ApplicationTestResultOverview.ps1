...
.PARAMETER ApplicationTestResult
...
function Initialize-LELEApplicationTestResultOverview {
    [CmdletBinding()]
    Param (
    ...
    Process {
        ...
        $PSO = [PSCustomObject]@{
            "applicationTestResult" = ${ApplicationTestResult}
        }
...
function ConvertFrom-LEJsonToApplicationTestResultOverview {
    ...
    Process {
        ...
        $AllProperties = ("applicationTestResult")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "applicationTestResult"))) { #optional property not found
            $ApplicationTestResult = $null
        } else {
            $ApplicationTestResult = $JsonParameters.PSobject.Properties["applicationTestResult"].value
        }
