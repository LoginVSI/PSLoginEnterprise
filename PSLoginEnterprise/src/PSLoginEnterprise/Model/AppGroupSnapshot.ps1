...
App group step snapshot

.PARAMETER Type
No description available.
.PARAMETER Name
Application group name
.PARAMETER GroupSteps
Group step
.OUTPUTS
...
function Initialize-LEAppGroupSnapshot {
    [CmdletBinding()]
    Param (
...
Convert from JSON to AppGroupSnapshot<PSCustomObject>
...
function ConvertFrom-LEJsonToAppGroupSnapshot {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "groupSteps"))) { #optional property not found
            $GroupSteps = $null
        } else {
            $GroupSteps = $JsonParameters.PSobject.Properties["groupSteps"].value
        }
