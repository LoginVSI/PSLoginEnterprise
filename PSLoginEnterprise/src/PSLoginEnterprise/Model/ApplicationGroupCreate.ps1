...
.PARAMETER Roles
The IDs of the roles to which this application group should be available. (User must be part of all the submitted roles)
.OUTPUTS

ApplicationGroupCreate<PSCustomObject>
#>

function Initialize-LELEApplicationGroupCreate {
    [CmdletBinding()]
    Param (
