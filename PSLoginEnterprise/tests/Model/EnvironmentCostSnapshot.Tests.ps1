...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironmentCostSnapshot' {
    Context 'LEEnvironmentCostSnapshot' {
        It 'Initialize-LELEEnvironmentCostSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironmentCostSnapshot -TimeStamp "TEST_VALUE" -Source "TEST_VALUE" -Currency "TEST_VALUE" -ExpectedUserAmount "TEST_VALUE" -ActualUserAmount "TEST_VALUE" -CapitalExpenditures "TEST_VALUE" -OperationalExpenditures "TEST_VALUE"
            #$NewObject | Should -BeOfType EnvironmentCostSnapshot
