...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationReplaceApplicationGroupStepsRequestInner' {
    Context 'LEConfigurationReplaceApplicationGroupStepsRequestInner' {
        It 'Initialize-LELEConfigurationReplaceApplicationGroupStepsRequestInner' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationReplaceApplicationGroupStepsRequestInner -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -ApplicationId "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -DelayInSeconds "TEST_VALUE" -ApplicationGroupId "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationReplaceApplicationGroupStepsRequestInner
