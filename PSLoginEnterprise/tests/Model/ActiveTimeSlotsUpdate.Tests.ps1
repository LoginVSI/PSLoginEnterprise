...
Describe -tag 'PSLoginEnterprise' -name 'LEActiveTimeSlotsUpdate' {
    Context 'LEActiveTimeSlotsUpdate' {
        It 'Initialize-LELEActiveTimeSlotsUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEActiveTimeSlotsUpdate -Mode "TEST_VALUE" -TimeSlots "TEST_VALUE"
            #$NewObject | Should -BeOfType ActiveTimeSlotsUpdate
