...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationResultStatus' {
    Context 'LEApplicationResultStatus' {
        It 'Initialize-LELEApplicationResultStatus' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationResultStatus
            #$NewObject | Should -BeOfType ApplicationResultStatus
