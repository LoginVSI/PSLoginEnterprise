...
Describe -tag 'PSLoginEnterprise' -name 'LEObjectIdList' {
    Context 'LEObjectIdList' {
        It 'Initialize-LELEObjectIdList' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEObjectIdList -IdList "TEST_VALUE"
            #$NewObject | Should -BeOfType ObjectIdList
