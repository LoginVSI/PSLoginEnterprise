...
Describe -tag 'PSLoginEnterprise' -name 'LEUserResultSet' {
    Context 'LEUserResultSet' {
        It 'Initialize-LELEUserResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType UserResultSet
