...
Describe -tag 'PSLoginEnterprise' -name 'LEVsiMax' {
    Context 'LEVsiMax' {
        It 'Initialize-LELEVsiMax' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEVsiMax -MaxSessions "TEST_VALUE" -Version "TEST_VALUE" -State "TEST_VALUE" -Timestamp "TEST_VALUE"
            #$NewObject | Should -BeOfType VsiMax
