...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxTimerResultsPerHour' {
    Context 'LEEuxTimerResultsPerHour' {
        It 'Initialize-LELEEuxTimerResultsPerHour' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxTimerResultsPerHour -Timestamp "TEST_VALUE" -Score "TEST_VALUE" -Count "TEST_VALUE" -EuxTimer "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxTimerResultsPerHour
