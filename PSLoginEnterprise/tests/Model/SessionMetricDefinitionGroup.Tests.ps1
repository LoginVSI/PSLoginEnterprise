...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricDefinitionGroup' {
    Context 'LESessionMetricDefinitionGroup' {
        It 'Initialize-LELESessionMetricDefinitionGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricDefinitionGroup -Key "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -MemberCount "TEST_VALUE" -Tests "TEST_VALUE"
            #$NewObject | Should -BeOfType SessionMetricDefinitionGroup
