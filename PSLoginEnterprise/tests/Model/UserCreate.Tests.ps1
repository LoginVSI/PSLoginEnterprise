...
Describe -tag 'PSLoginEnterprise' -name 'LEUserCreate' {
    Context 'LEUserCreate' {
        It 'Initialize-LELEUserCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserCreate -UserName "TEST_VALUE" -UserType "TEST_VALUE" -RoleIds "TEST_VALUE"
            #$NewObject | Should -BeOfType UserCreate
