...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherSortKey' {
    Context 'LELauncherSortKey' {
        It 'Initialize-LELELauncherSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherSortKey
            #$NewObject | Should -BeOfType LauncherSortKey
