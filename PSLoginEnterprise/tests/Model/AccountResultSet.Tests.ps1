...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountResultSet' {
    Context 'LEAccountResultSet' {
        It 'Initialize-LELEAccountResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountResultSet
