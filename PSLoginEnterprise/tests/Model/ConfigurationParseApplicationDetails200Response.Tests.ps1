...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationParseApplicationDetails200Response' {
    Context 'LEConfigurationParseApplicationDetails200Response' {
        It 'Initialize-LELEConfigurationParseApplicationDetails200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationParseApplicationDetails200Response -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationParseApplicationDetails200Response
