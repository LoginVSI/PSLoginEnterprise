...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountUpdate' {
    Context 'LEAccountUpdate' {
        It 'Initialize-LELEAccountUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountUpdate -Password "TEST_VALUE" -Username "TEST_VALUE" -Domain "TEST_VALUE" -Email "TEST_VALUE" -Fields "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountUpdate
