...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestAppThresholdSnapshot' {
    Context 'LEApplicationTestAppThresholdSnapshot' {
        It 'Initialize-LELEApplicationTestAppThresholdSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestAppThresholdSnapshot -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -ApplicationName "TEST_VALUE" -Timer "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestAppThresholdSnapshot
