...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxScriptExecutionResultSet' {
    Context 'LEEuxScriptExecutionResultSet' {
        It 'Initialize-LELEEuxScriptExecutionResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxScriptExecutionResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxScriptExecutionResultSet
