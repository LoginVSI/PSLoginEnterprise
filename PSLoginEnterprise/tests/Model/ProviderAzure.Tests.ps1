...
Describe -tag 'PSLoginEnterprise' -name 'LEProviderAzure' {
    Context 'LEProviderAzure' {
        It 'Initialize-LELEProviderAzure' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProviderAzure -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Environments "TEST_VALUE" -TenantId "TEST_VALUE" -ApplicationId "TEST_VALUE"
            #$NewObject | Should -BeOfType ProviderAzure
