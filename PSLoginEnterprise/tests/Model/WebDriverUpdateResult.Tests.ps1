...
Describe -tag 'PSLoginEnterprise' -name 'LEWebDriverUpdateResult' {
    Context 'LEWebDriverUpdateResult' {
        It 'Initialize-LELEWebDriverUpdateResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebDriverUpdateResult -BrowserName "TEST_VALUE" -Version "TEST_VALUE" -VarError "TEST_VALUE" -IsSuccessful "TEST_VALUE"
            #$NewObject | Should -BeOfType WebDriverUpdateResult
