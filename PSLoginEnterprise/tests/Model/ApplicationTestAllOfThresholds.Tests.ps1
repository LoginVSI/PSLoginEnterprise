...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestAllOfThresholds' {
    Context 'LEApplicationTestAllOfThresholds' {
        It 'Initialize-LELEApplicationTestAllOfThresholds' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestAllOfThresholds -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -ApplicationId "TEST_VALUE" -ApplicationName "TEST_VALUE" -Timer "TEST_VALUE" -Target "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestAllOfThresholds
