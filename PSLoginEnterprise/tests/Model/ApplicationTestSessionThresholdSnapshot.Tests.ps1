...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestSessionThresholdSnapshot' {
    Context 'LEApplicationTestSessionThresholdSnapshot' {
        It 'Initialize-LELEApplicationTestSessionThresholdSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestSessionThresholdSnapshot -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -Target "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestSessionThresholdSnapshot
