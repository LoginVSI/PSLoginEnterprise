...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxTimerResult' {
    Context 'LEEuxTimerResult' {
        It 'Initialize-LELEEuxTimerResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxTimerResult -Timestamp "TEST_VALUE" -Score "TEST_VALUE" -EuxTimer "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxTimerResult
