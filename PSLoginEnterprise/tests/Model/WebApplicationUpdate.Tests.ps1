...
Describe -tag 'PSLoginEnterprise' -name 'LEWebApplicationUpdate' {
    Context 'LEWebApplicationUpdate' {
        It 'Initialize-LELEWebApplicationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebApplicationUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -MustUpdatePassword "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE"
            #$NewObject | Should -BeOfType WebApplicationUpdate
