...
Describe -tag 'PSLoginEnterprise' -name 'LEReportConfiguration' {
    Context 'LEReportConfiguration' {
        It 'Initialize-LELEReportConfiguration' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportConfiguration -Id "TEST_VALUE" -TestId "TEST_VALUE" -Name "TEST_VALUE" -TestName "TEST_VALUE" -Description "TEST_VALUE" -Frequency "TEST_VALUE" -IsEnabled "TEST_VALUE" -Notification "TEST_VALUE" -Thresholds "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -LastReportPeriodStart "TEST_VALUE" -TimeZoneOffset "TEST_VALUE"
