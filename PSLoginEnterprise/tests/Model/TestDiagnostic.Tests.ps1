...
Describe -tag 'PSLoginEnterprise' -name 'LETestDiagnostic' {
    Context 'LETestDiagnostic' {
        It 'Initialize-LELETestDiagnostic' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestDiagnostic -TestId "TEST_VALUE" -TestName "TEST_VALUE" -ActiveSessionCount "TEST_VALUE" -ActiveAccountCount "TEST_VALUE" -ActiveLauncherCount "TEST_VALUE" -LoginFailures "TEST_VALUE" -AppFailures "TEST_VALUE" -AppPerformance "TEST_VALUE" -Latency "TEST_VALUE" -LoginPerformance "TEST_VALUE"
