...
Describe -tag 'PSLoginEnterprise' -name 'LERoleCreate' {
    Context 'LERoleCreate' {
        It 'Initialize-LELERoleCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELERoleCreate -Name "TEST_VALUE" -UserIds "TEST_VALUE" -LdapGroupIds "TEST_VALUE" -Permissions "TEST_VALUE"
            #$NewObject | Should -BeOfType RoleCreate
