...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroupResultSet' {
    Context 'LEAccountGroupResultSet' {
        It 'Initialize-LELEAccountGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountGroupResultSet
