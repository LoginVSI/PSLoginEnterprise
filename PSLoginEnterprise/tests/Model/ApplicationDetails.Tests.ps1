...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationDetails' {
    Context 'LEApplicationDetails' {
        It 'Initialize-LELEApplicationDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationDetails -Type "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationDetails
