...
Describe -tag 'PSLoginEnterprise' -name 'LEWebApplicationCreate' {
    Context 'LEWebApplicationCreate' {
        It 'Initialize-LELEWebApplicationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebApplicationCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE" -Roles "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE"
            #$NewObject | Should -BeOfType WebApplicationCreate
