...
Describe -tag 'PSLoginEnterprise' -name 'LELoadTestUpdate' {
    Context 'LELoadTestUpdate' {
        It 'Initialize-LELELoadTestUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELoadTestUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -ConnectionResourcesUpdate "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Steps "TEST_VALUE" -LogonTimeTrackingProcess "TEST_VALUE" -EngineStartTimeout "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -RampUpDurationInMinutes "TEST_VALUE" -TestDurationInMinutes "TEST_VALUE" -EuxEnabled "TEST_VALUE" -EuxWorkFolders "TEST_VALUE" -SessionMetricsEnabled "TEST_VALUE" -SessionMetricScheduleRate "TEST_VALUE" -SessionMetricGroupKey "TEST_VALUE"
            #$NewObject | Should -BeOfType LoadTestUpdate
