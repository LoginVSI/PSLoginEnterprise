...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroup' {
    Context 'LEApplicationGroup' {
        It 'Initialize-LELEApplicationGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroup -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -MemberCount "TEST_VALUE" -Steps "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationGroup
