...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountSortKey' {
    Context 'LEAccountSortKey' {
        It 'Initialize-LELEAccountSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountSortKey
            #$NewObject | Should -BeOfType AccountSortKey
