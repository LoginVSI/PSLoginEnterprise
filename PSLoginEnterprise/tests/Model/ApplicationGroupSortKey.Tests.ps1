...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroupSortKey' {
    Context 'LEApplicationGroupSortKey' {
        It 'Initialize-LELEApplicationGroupSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroupSortKey
            #$NewObject | Should -BeOfType ApplicationGroupSortKey
