...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironmentAttributes' {
    Context 'LEEnvironmentAttributes' {
        It 'Initialize-LELEEnvironmentAttributes' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironmentAttributes -ResourceGroup "TEST_VALUE" -HostPool "TEST_VALUE"
            #$NewObject | Should -BeOfType EnvironmentAttributes
