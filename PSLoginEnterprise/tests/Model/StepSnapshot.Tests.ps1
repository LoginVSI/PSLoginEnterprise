...
Describe -tag 'PSLoginEnterprise' -name 'LEStepSnapshot' {
    Context 'LEStepSnapshot' {
        It 'Initialize-LELEStepSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEStepSnapshot -Type "TEST_VALUE"
            #$NewObject | Should -BeOfType StepSnapshot
