...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherFilterGroupData' {
    Context 'LELauncherFilterGroupData' {
        It 'Initialize-LELELauncherFilterGroupData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherFilterGroupData -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -VarFilter "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherFilterGroupData
