...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherGroup' {
    Context 'LELauncherGroup' {
        It 'Initialize-LELELauncherGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherGroup -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Members "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherGroup
