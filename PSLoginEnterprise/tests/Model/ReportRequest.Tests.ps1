...
Describe -tag 'PSLoginEnterprise' -name 'LEReportRequest' {
    Context 'LEReportRequest' {
        It 'Initialize-LELEReportRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportRequest -ReportPeriodStart "TEST_VALUE"
            #$NewObject | Should -BeOfType ReportRequest
