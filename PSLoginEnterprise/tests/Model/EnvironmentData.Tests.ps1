...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironmentData' {
    Context 'LEEnvironmentData' {
        It 'Initialize-LELEEnvironmentData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironmentData -Name "TEST_VALUE" -Description "TEST_VALUE" -EnableEnvironmentDataCollection "TEST_VALUE" -EnableCostCalculation "TEST_VALUE" -EnvironmentCost "TEST_VALUE" -EnvironmentAttributes "TEST_VALUE" -ProviderId "TEST_VALUE"
            #$NewObject | Should -BeOfType EnvironmentData
