...
Describe -tag 'PSLoginEnterprise' -name 'LESuccessCounts' {
    Context 'LESuccessCounts' {
        It 'Initialize-LELESuccessCounts' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESuccessCounts -SuccessCount "TEST_VALUE" -TotalCount "TEST_VALUE"
            #$NewObject | Should -BeOfType SuccessCounts
