...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherResultSet' {
    Context 'LELauncherResultSet' {
        It 'Initialize-LELELauncherResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherResultSet
