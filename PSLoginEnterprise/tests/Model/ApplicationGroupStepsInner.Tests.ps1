...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroupStepsInner' {
    Context 'LEApplicationGroupStepsInner' {
        It 'Initialize-LELEApplicationGroupStepsInner' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroupStepsInner -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Application "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -DelayInSeconds "TEST_VALUE" -ApplicationGroup "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationGroupStepsInner
