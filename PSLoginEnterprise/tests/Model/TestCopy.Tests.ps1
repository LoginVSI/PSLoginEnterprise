...
Describe -tag 'PSLoginEnterprise' -name 'LETestCopy' {
    Context 'LETestCopy' {
        It 'Initialize-LELETestCopy' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestCopy -Name "TEST_VALUE"
            #$NewObject | Should -BeOfType TestCopy
