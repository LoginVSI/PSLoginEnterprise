...
Describe -tag 'PSLoginEnterprise' -name 'LEResolution' {
    Context 'LEResolution' {
        It 'Initialize-LELEResolution' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEResolution -Width "TEST_VALUE" -Height "TEST_VALUE"
