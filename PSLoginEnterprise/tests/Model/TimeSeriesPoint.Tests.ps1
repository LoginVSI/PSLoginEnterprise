...
Describe -tag 'PSLoginEnterprise' -name 'LETimeSeriesPoint' {
    Context 'LETimeSeriesPoint' {
        It 'Initialize-LELETimeSeriesPoint' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETimeSeriesPoint -Timestamp "TEST_VALUE" -Value "TEST_VALUE"
            #$NewObject | Should -BeOfType TimeSeriesPoint
