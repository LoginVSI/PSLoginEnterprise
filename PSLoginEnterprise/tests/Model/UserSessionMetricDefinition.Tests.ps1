...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricDefinition' {
    Context 'LEUserSessionMetricDefinition' {
        It 'Initialize-LELEUserSessionMetricDefinition' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricDefinition -Type "TEST_VALUE" -Key "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionMetricDefinition
