...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountSelectionGroupUpdate' {
    Context 'LEAccountSelectionGroupUpdate' {
        It 'Initialize-LELEAccountSelectionGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountSelectionGroupUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -MemberIds "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountSelectionGroupUpdate
