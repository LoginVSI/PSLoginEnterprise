...
Describe -tag 'PSLoginEnterprise' -name 'LETestUpdate' {
    Context 'LETestUpdate' {
        It 'Initialize-LELETestUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -ConnectionResourcesUpdate "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Steps "TEST_VALUE" -LogonTimeTrackingProcess "TEST_VALUE" -EngineStartTimeout "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE"
            #$NewObject | Should -BeOfType TestUpdate
