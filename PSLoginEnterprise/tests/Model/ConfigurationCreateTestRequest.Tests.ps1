...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationCreateTestRequest' {
    Context 'LEConfigurationCreateTestRequest' {
        It 'Initialize-LELEConfigurationCreateTestRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationCreateTestRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Connector "TEST_VALUE" -AccountGroups "TEST_VALUE" -LauncherGroups "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -Roles "TEST_VALUE" -SessionMetricsEnabled "TEST_VALUE" -SessionMetricScheduleRate "TEST_VALUE" -SessionMetricGroupKey "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationCreateTestRequest
