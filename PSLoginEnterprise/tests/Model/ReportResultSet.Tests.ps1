...
Describe -tag 'PSLoginEnterprise' -name 'LEReportResultSet' {
    Context 'LEReportResultSet' {
        It 'Initialize-LELEReportResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType ReportResultSet
