...
Describe -tag 'PSLoginEnterprise' -name 'LERdpConnector' {
    Context 'LERdpConnector' {
        It 'Initialize-LELERdpConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELERdpConnector -Type "TEST_VALUE" -HostList "TEST_VALUE" -Resource "TEST_VALUE" -Gateway "TEST_VALUE" -SuppressCertWarn "TEST_VALUE" -DisplayResolution "TEST_VALUE"
            #$NewObject | Should -BeOfType RdpConnector
