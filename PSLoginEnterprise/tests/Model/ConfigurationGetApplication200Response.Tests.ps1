...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationGetApplication200Response' {
    Context 'LEConfigurationGetApplication200Response' {
        It 'Initialize-LELEConfigurationGetApplication200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationGetApplication200Response -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Script "TEST_VALUE" -Timers "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -HasPassword "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE" -MainWindowTitle "TEST_VALUE" -MainProcessName "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationGetApplication200Response
