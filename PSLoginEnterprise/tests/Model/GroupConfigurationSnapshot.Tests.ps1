...
Describe -tag 'PSLoginEnterprise' -name 'LEGroupConfigurationSnapshot' {
    Context 'LEGroupConfigurationSnapshot' {
        It 'Initialize-LELEGroupConfigurationSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEGroupConfigurationSnapshot -GroupId "TEST_VALUE" -Name "TEST_VALUE"
            #$NewObject | Should -BeOfType GroupConfigurationSnapshot
