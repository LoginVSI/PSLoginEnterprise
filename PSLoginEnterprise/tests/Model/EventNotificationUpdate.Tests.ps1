...
Describe -tag 'PSLoginEnterprise' -name 'LEEventNotificationUpdate' {
    Context 'LEEventNotificationUpdate' {
        It 'Initialize-LELEEventNotificationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEventNotificationUpdate -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE"
            #$NewObject | Should -BeOfType EventNotificationUpdate
