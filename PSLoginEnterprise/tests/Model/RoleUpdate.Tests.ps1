...
Describe -tag 'PSLoginEnterprise' -name 'LERoleUpdate' {
    Context 'LERoleUpdate' {
        It 'Initialize-LELERoleUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELERoleUpdate -Name "TEST_VALUE" -UserIds "TEST_VALUE" -LdapGroupIds "TEST_VALUE" -Permissions "TEST_VALUE"
            #$NewObject | Should -BeOfType RoleUpdate
