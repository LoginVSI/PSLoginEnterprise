...
Describe -tag 'PSLoginEnterprise' -name 'LETestRunResultSet' {
    Context 'LETestRunResultSet' {
        It 'Initialize-LELETestRunResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestRunResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType TestRunResultSet
