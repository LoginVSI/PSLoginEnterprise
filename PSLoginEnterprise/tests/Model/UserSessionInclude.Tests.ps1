...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionInclude' {
    Context 'LEUserSessionInclude' {
        It 'Initialize-LELEUserSessionInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionInclude
            #$NewObject | Should -BeOfType UserSessionInclude
