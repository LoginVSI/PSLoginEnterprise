...
Describe -tag 'PSLoginEnterprise' -name 'LEBuiltInMetricDefinition' {
    Context 'LEBuiltInMetricDefinition' {
        It 'Initialize-LELEBuiltInMetricDefinition' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEBuiltInMetricDefinition -Type "TEST_VALUE" -Key "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE" -Measurement "TEST_VALUE"
            #$NewObject | Should -BeOfType BuiltInMetricDefinition
