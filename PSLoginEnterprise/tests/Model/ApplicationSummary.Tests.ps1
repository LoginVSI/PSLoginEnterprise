...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationSummary' {
    Context 'LEApplicationSummary' {
        It 'Initialize-LELEApplicationSummary' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationSummary -ApplicationId "TEST_VALUE" -ApplicationName "TEST_VALUE" -ResultStatus "TEST_VALUE" -AppExecutionSuccessful "TEST_VALUE" -PerformanceSuccessful "TEST_VALUE" -TimerResults "TEST_VALUE" -Screenshots "TEST_VALUE"
