...
Describe -tag 'PSLoginEnterprise' -name 'LEHorizonConnector' {
    Context 'LEHorizonConnector' {
        It 'Initialize-LELEHorizonConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEHorizonConnector -Type "TEST_VALUE" -ServerUrl "TEST_VALUE" -Resource "TEST_VALUE" -CommandLine "TEST_VALUE"
            #$NewObject | Should -BeOfType HorizonConnector
