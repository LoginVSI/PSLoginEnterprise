...
Describe -tag 'PSLoginEnterprise' -name 'LEThresholdNotification' {
    Context 'LEThresholdNotification' {
        It 'Initialize-LELEThresholdNotification' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEThresholdNotification -Type "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE" -Threshold "TEST_VALUE"
            #$NewObject | Should -BeOfType ThresholdNotification
