...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroupType' {
    Context 'LEAccountGroupType' {
        It 'Initialize-LELEAccountGroupType' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroupType
            #$NewObject | Should -BeOfType AccountGroupType
