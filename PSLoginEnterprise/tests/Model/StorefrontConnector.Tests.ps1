...
Describe -tag 'PSLoginEnterprise' -name 'LEStorefrontConnector' {
    Context 'LEStorefrontConnector' {
        It 'Initialize-LELEStorefrontConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEStorefrontConnector -Type "TEST_VALUE" -ServerUrl "TEST_VALUE" -Resource "TEST_VALUE" -DisplayResolution "TEST_VALUE" -SeamlessMode "TEST_VALUE"
            #$NewObject | Should -BeOfType StorefrontConnector
