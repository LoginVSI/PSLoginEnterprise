...
Describe -tag 'PSLoginEnterprise' -name 'LESessionThreshold' {
    Context 'LESessionThreshold' {
        It 'Initialize-LELESessionThreshold' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionThreshold -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -Target "TEST_VALUE"
            #$NewObject | Should -BeOfType SessionThreshold
