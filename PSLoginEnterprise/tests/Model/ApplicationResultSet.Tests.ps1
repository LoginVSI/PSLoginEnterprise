...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationResultSet' {
    Context 'LEApplicationResultSet' {
        It 'Initialize-LELEApplicationResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationResultSet
