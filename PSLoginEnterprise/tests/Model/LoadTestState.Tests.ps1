...
Describe -tag 'PSLoginEnterprise' -name 'LELoadTestState' {
    Context 'LELoadTestState' {
        It 'Initialize-LELELoadTestState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELoadTestState
            #$NewObject | Should -BeOfType LoadTestState
