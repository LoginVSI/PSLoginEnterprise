...
Describe -tag 'PSLoginEnterprise' -name 'LEUser' {
    Context 'LEUser' {
        It 'Initialize-LELEUser' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUser -Id "TEST_VALUE" -UserName "TEST_VALUE" -LastLoginTime "TEST_VALUE" -UserType "TEST_VALUE" -CreatedTime "TEST_VALUE" -LastModifiedTime "TEST_VALUE" -Roles "TEST_VALUE"
