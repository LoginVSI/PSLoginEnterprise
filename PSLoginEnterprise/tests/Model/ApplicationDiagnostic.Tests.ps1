...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationDiagnostic' {
    Context 'LEApplicationDiagnostic' {
        It 'Initialize-LELEApplicationDiagnostic' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationDiagnostic -ApplicationId "TEST_VALUE" -ApplicationName "TEST_VALUE" -AboveThreshold "TEST_VALUE" -TotalMeasurements "TEST_VALUE" -Percentage "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationDiagnostic
