...
Describe -tag 'PSLoginEnterprise' -name 'LEDelayCreate' {
    Context 'LEDelayCreate' {
        It 'Initialize-LELEDelayCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDelayCreate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -DelayInSeconds "TEST_VALUE"
            #$NewObject | Should -BeOfType DelayCreate
