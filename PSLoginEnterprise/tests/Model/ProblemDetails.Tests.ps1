...
Describe -tag 'PSLoginEnterprise' -name 'LEProblemDetails' {
    Context 'LEProblemDetails' {
        It 'Initialize-LELEProblemDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProblemDetails -Type "TEST_VALUE" -Title "TEST_VALUE" -Status "TEST_VALUE" -Detail "TEST_VALUE" -Instance "TEST_VALUE"
