...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxWorkFolders' {
    Context 'LEEuxWorkFolders' {
        It 'Initialize-LELEEuxWorkFolders' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxWorkFolders -EuxFolderPath "TEST_VALUE" -AppDataFolderPath "TEST_VALUE" -MyDocumentsFolderPath "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxWorkFolders
