...
Describe -tag 'PSLoginEnterprise' -name 'LEWmiQueryDefinition' {
    Context 'LEWmiQueryDefinition' {
        It 'Initialize-LELEWmiQueryDefinition' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWmiQueryDefinition -Type "TEST_VALUE" -Key "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE" -WmiQuery "TEST_VALUE" -Namespace "TEST_VALUE" -InstanceField "TEST_VALUE" -Measurements "TEST_VALUE"
            #$NewObject | Should -BeOfType WmiQueryDefinition
