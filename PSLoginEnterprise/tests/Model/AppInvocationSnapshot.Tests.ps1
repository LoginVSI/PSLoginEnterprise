...
Describe -tag 'PSLoginEnterprise' -name 'LEAppInvocationSnapshot' {
    Context 'LEAppInvocationSnapshot' {
        It 'Initialize-LELEAppInvocationSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppInvocationSnapshot -Type "TEST_VALUE" -AppId "TEST_VALUE" -ApplicationName "TEST_VALUE" -Timers "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE"
            #$NewObject | Should -BeOfType AppInvocationSnapshot
