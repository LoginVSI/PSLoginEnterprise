...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherProperty' {
    Context 'LELauncherProperty' {
        It 'Initialize-LELELauncherProperty' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherProperty -PropertyId "TEST_VALUE" -Value "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherProperty
