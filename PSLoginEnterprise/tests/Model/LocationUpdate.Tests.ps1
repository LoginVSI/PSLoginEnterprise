...
Describe -tag 'PSLoginEnterprise' -name 'LELocationUpdate' {
    Context 'LELocationUpdate' {
        It 'Initialize-LELELocationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELocationUpdate -Name "TEST_VALUE" -Latitude "TEST_VALUE" -Longitude "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType LocationUpdate
