...
Describe -tag 'PSLoginEnterprise' -name 'LEPlatformMetricSeries' {
    Context 'LEPlatformMetricSeries' {
        It 'Initialize-LELEPlatformMetricSeries' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPlatformMetricSeries -MetricId "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE" -Instance "TEST_VALUE" -Group "TEST_VALUE" -ComponentType "TEST_VALUE" -CustomTags "TEST_VALUE" -DataPoints "TEST_VALUE"
            #$NewObject | Should -BeOfType PlatformMetricSeries
