...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherGroupSortKey' {
    Context 'LELauncherGroupSortKey' {
        It 'Initialize-LELELauncherGroupSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherGroupSortKey
            #$NewObject | Should -BeOfType LauncherGroupSortKey
