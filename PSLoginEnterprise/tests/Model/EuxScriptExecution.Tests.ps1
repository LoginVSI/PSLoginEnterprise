...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxScriptExecution' {
    Context 'LEEuxScriptExecution' {
        It 'Initialize-LELEEuxScriptExecution' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxScriptExecution -UserSessionId "TEST_VALUE" -StartTime "TEST_VALUE" -EndTime "TEST_VALUE" -Successful "TEST_VALUE" -EuxMeasurements "TEST_VALUE" -Properties "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxScriptExecution
