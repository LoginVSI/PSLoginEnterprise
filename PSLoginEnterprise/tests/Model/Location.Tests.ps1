...
Describe -tag 'PSLoginEnterprise' -name 'LELocation' {
    Context 'LELocation' {
        It 'Initialize-LELELocation' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELocation -Id "TEST_VALUE" -Name "TEST_VALUE" -Latitude "TEST_VALUE" -Longitude "TEST_VALUE" -Description "TEST_VALUE" -LauncherNames "TEST_VALUE"
