...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationCreateLauncherGroupRequest' {
    Context 'LEConfigurationCreateLauncherGroupRequest' {
        It 'Initialize-LELEConfigurationCreateLauncherGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationCreateLauncherGroupRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -VarFilter "TEST_VALUE" -LauncherNames "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationCreateLauncherGroupRequest
