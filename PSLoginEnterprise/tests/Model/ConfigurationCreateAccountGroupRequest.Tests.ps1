...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationCreateAccountGroupRequest' {
    Context 'LEConfigurationCreateAccountGroupRequest' {
        It 'Initialize-LELEConfigurationCreateAccountGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationCreateAccountGroupRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -VarFilter "TEST_VALUE" -MemberIds "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationCreateAccountGroupRequest
