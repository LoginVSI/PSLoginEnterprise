...
Describe -tag 'PSLoginEnterprise' -name 'LEWindowsApplicationUpdate' {
    Context 'LEWindowsApplicationUpdate' {
        It 'Initialize-LELEWindowsApplicationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWindowsApplicationUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -MustUpdatePassword "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
            #$NewObject | Should -BeOfType WindowsApplicationUpdate
