...
Describe -tag 'PSLoginEnterprise' -name 'LEStringStringKeyValuePair' {
    Context 'LEStringStringKeyValuePair' {
        It 'Initialize-LELEStringStringKeyValuePair' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEStringStringKeyValuePair -Key "TEST_VALUE" -Value "TEST_VALUE"
