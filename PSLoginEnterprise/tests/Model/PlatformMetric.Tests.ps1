...
Describe -tag 'PSLoginEnterprise' -name 'LEPlatformMetric' {
    Context 'LEPlatformMetric' {
        It 'Initialize-LELEPlatformMetric' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPlatformMetric -MetricId "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Timestamp "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE" -Instance "TEST_VALUE" -Value "TEST_VALUE" -Group "TEST_VALUE" -ComponentType "TEST_VALUE" -CustomTags "TEST_VALUE"
            #$NewObject | Should -BeOfType PlatformMetric
