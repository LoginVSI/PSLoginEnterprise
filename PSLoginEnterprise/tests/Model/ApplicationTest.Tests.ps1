...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTest' {
    Context 'LEApplicationTest' {
        It 'Initialize-LELEApplicationTest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTest -Type "TEST_VALUE" -Id "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -ConnectionResources "TEST_VALUE" -Workload "TEST_VALUE" -LogonTimeTrackingProcess "TEST_VALUE" -EngineStartTimeout "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -IsEmailEnabled "TEST_VALUE" -EmailRecipient "TEST_VALUE" -IncludeSuccessfulApplications "TEST_VALUE" -RestartOnComplete "TEST_VALUE" -State "TEST_VALUE" -Thresholds "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTest
