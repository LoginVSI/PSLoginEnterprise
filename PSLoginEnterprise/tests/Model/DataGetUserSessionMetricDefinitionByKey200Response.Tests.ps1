...
Describe -tag 'PSLoginEnterprise' -name 'LEDataGetUserSessionMetricDefinitionByKey200Response' {
    Context 'LEDataGetUserSessionMetricDefinitionByKey200Response' {
        It 'Initialize-LELEDataGetUserSessionMetricDefinitionByKey200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDataGetUserSessionMetricDefinitionByKey200Response -Type "TEST_VALUE" -Key "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE" -Measurement "TEST_VALUE" -WmiQuery "TEST_VALUE" -Namespace "TEST_VALUE" -InstanceField "TEST_VALUE" -Measurements "TEST_VALUE"
            #$NewObject | Should -BeOfType DataGetUserSessionMetricDefinitionByKey200Response
