...
Describe -tag 'PSLoginEnterprise' -name 'LEAppPerformanceResult' {
    Context 'LEAppPerformanceResult' {
        It 'Initialize-LELEAppPerformanceResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppPerformanceResult -AppResponseTime "TEST_VALUE" -TotalAppPerformance "TEST_VALUE"
            #$NewObject | Should -BeOfType AppPerformanceResult
