...
Describe -tag 'PSLoginEnterprise' -name 'LEAppGroupReferenceCreate' {
    Context 'LEAppGroupReferenceCreate' {
        It 'Initialize-LELEAppGroupReferenceCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppGroupReferenceCreate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -ApplicationGroupId "TEST_VALUE"
            #$NewObject | Should -BeOfType AppGroupReferenceCreate
