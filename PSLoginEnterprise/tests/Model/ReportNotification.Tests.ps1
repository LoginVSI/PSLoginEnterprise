...
Describe -tag 'PSLoginEnterprise' -name 'LEReportNotification' {
    Context 'LEReportNotification' {
        It 'Initialize-LELEReportNotification' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportNotification -IsEnabled "TEST_VALUE" -Recipient "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
            #$NewObject | Should -BeOfType ReportNotification
