...
Describe -tag 'PSLoginEnterprise' -name 'LEStepCreate' {
    Context 'LEStepCreate' {
        It 'Initialize-LELEStepCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEStepCreate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE"
            #$NewObject | Should -BeOfType StepCreate
