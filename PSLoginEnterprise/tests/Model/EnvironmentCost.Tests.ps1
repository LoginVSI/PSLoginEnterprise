...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironmentCost' {
    Context 'LEEnvironmentCost' {
        It 'Initialize-LELEEnvironmentCost' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironmentCost -Currency "TEST_VALUE" -ExpectedUserAmount "TEST_VALUE" -ActualUserAmount "TEST_VALUE" -CapitalExpenditures "TEST_VALUE" -OperationalExpenditures "TEST_VALUE"
            #$NewObject | Should -BeOfType EnvironmentCost
