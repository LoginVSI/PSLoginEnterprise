...
Describe -tag 'PSLoginEnterprise' -name 'LESystemEuxVersion' {
    Context 'LESystemEuxVersion' {
        It 'Initialize-LELESystemEuxVersion' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESystemEuxVersion -Version "TEST_VALUE"
            #$NewObject | Should -BeOfType SystemEuxVersion
