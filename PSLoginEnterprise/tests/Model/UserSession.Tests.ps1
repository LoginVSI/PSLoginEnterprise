...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSession' {
    Context 'LEUserSession' {
        It 'Initialize-LELEUserSession' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSession -Id "TEST_VALUE" -TestId "TEST_VALUE" -TestRunId "TEST_VALUE" -Created "TEST_VALUE" -LoginState "TEST_VALUE" -SessionState "TEST_VALUE" -StateLastModified "TEST_VALUE" -TestType "TEST_VALUE" -AccountId "TEST_VALUE" -LauncherName "TEST_VALUE" -LoginStartTime "TEST_VALUE" -LoginEndTime "TEST_VALUE" -SessionEndTime "TEST_VALUE" -SessionMetricEnabled "TEST_VALUE" -Properties "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSession
