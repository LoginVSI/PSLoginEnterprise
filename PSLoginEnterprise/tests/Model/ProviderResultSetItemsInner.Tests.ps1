...
Describe -tag 'PSLoginEnterprise' -name 'LEProviderResultSetItemsInner' {
    Context 'LEProviderResultSetItemsInner' {
        It 'Initialize-LELEProviderResultSetItemsInner' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProviderResultSetItemsInner -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Environments "TEST_VALUE" -TenantId "TEST_VALUE" -ApplicationId "TEST_VALUE"
            #$NewObject | Should -BeOfType ProviderResultSetItemsInner
