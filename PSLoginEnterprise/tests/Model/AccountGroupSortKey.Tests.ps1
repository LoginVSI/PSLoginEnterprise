...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroupSortKey' {
    Context 'LEAccountGroupSortKey' {
        It 'Initialize-LELEAccountGroupSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroupSortKey
            #$NewObject | Should -BeOfType AccountGroupSortKey
