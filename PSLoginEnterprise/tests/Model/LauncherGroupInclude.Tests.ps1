...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherGroupInclude' {
    Context 'LELauncherGroupInclude' {
        It 'Initialize-LELELauncherGroupInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherGroupInclude
            #$NewObject | Should -BeOfType LauncherGroupInclude
