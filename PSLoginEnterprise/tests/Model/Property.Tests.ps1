...
Describe -tag 'PSLoginEnterprise' -name 'LEProperty' {
    Context 'LEProperty' {
        It 'Initialize-LELEProperty' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProperty -PropertyId "TEST_VALUE" -Value "TEST_VALUE"
            #$NewObject | Should -BeOfType Property
