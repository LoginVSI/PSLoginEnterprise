...
Describe -tag 'PSLoginEnterprise' -name 'LEThresholdNotificationCreate' {
    Context 'LEThresholdNotificationCreate' {
        It 'Initialize-LELEThresholdNotificationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEThresholdNotificationCreate -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE" -Threshold "TEST_VALUE"
            #$NewObject | Should -BeOfType ThresholdNotificationCreate
