...
Describe -tag 'PSLoginEnterprise' -name 'LEEventNotification' {
    Context 'LEEventNotification' {
        It 'Initialize-LELEEventNotification' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEventNotification -Type "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE" -VarEvent "TEST_VALUE" -LastModified "TEST_VALUE"
