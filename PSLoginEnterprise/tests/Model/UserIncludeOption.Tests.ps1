...
Describe -tag 'PSLoginEnterprise' -name 'LEUserIncludeOption' {
    Context 'LEUserIncludeOption' {
        It 'Initialize-LELEUserIncludeOption' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserIncludeOption
            #$NewObject | Should -BeOfType UserIncludeOption
