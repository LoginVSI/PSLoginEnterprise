...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroupResultSet' {
    Context 'LEApplicationGroupResultSet' {
        It 'Initialize-LELEApplicationGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationGroupResultSet
