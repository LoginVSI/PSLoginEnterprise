...
Describe -tag 'PSLoginEnterprise' -name 'LEStepUpdate' {
    Context 'LEStepUpdate' {
        It 'Initialize-LELEStepUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEStepUpdate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE"
            #$NewObject | Should -BeOfType StepUpdate
