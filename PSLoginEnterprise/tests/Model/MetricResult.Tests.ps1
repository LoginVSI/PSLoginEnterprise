...
Describe -tag 'PSLoginEnterprise' -name 'LEMetricResult' {
    Context 'LEMetricResult' {
        It 'Initialize-LELEMetricResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEMetricResult -ResultId "TEST_VALUE" -Value "TEST_VALUE" -DifferenceFromBase "TEST_VALUE"
            #$NewObject | Should -BeOfType MetricResult
