...
Describe -tag 'PSLoginEnterprise' -name 'LEDataGetApplicationTestReport200Response' {
    Context 'LEDataGetApplicationTestReport200Response' {
        It 'Initialize-LELEDataGetApplicationTestReport200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDataGetApplicationTestReport200Response -Type "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -OutputContentUri "TEST_VALUE" -State "TEST_VALUE" -Trigger "TEST_VALUE" -Created "TEST_VALUE" -ReportPeriodStart "TEST_VALUE" -ReportPeriodEnd "TEST_VALUE" -TestRunId "TEST_VALUE" -ConfigurationId "TEST_VALUE"
            #$NewObject | Should -BeOfType DataGetApplicationTestReport200Response
