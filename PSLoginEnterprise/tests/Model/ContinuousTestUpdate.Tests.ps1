...
Describe -tag 'PSLoginEnterprise' -name 'LEContinuousTestUpdate' {
    Context 'LEContinuousTestUpdate' {
        It 'Initialize-LELEContinuousTestUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEContinuousTestUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -ConnectionResourcesUpdate "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Steps "TEST_VALUE" -LogonTimeTrackingProcess "TEST_VALUE" -EngineStartTimeout "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -ScheduleType "TEST_VALUE" -IntervalInMinutes "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -EnableCustomScreenshots "TEST_VALUE" -RepeatCount "TEST_VALUE" -IsRepeatEnabled "TEST_VALUE" -IsEnabled "TEST_VALUE" -RestartOnComplete "TEST_VALUE" -EuxEnabled "TEST_VALUE" -EuxWorkFolders "TEST_VALUE" -SessionMetricsEnabled "TEST_VALUE" -SessionMetricScheduleRate "TEST_VALUE" -SessionMetricGroupKey "TEST_VALUE"
            #$NewObject | Should -BeOfType ContinuousTestUpdate
