...
Describe -tag 'PSLoginEnterprise' -name 'LEDesktopConnector' {
    Context 'LEDesktopConnector' {
        It 'Initialize-LELEDesktopConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDesktopConnector -Type "TEST_VALUE"
            #$NewObject | Should -BeOfType DesktopConnector
