...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricDefinitionSnapshot' {
    Context 'LESessionMetricDefinitionSnapshot' {
        It 'Initialize-LELESessionMetricDefinitionSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricDefinitionSnapshot -MetricId "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE"
            #$NewObject | Should -BeOfType SessionMetricDefinitionSnapshot
