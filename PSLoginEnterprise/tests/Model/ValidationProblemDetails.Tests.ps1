...
Describe -tag 'PSLoginEnterprise' -name 'LEValidationProblemDetails' {
    Context 'LEValidationProblemDetails' {
        It 'Initialize-LELEValidationProblemDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEValidationProblemDetails -Errors "TEST_VALUE" -Type "TEST_VALUE" -Title "TEST_VALUE" -Status "TEST_VALUE" -Detail "TEST_VALUE" -Instance "TEST_VALUE"
            #$NewObject | Should -BeOfType ValidationProblemDetails
