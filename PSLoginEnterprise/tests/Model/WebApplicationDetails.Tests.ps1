...
Describe -tag 'PSLoginEnterprise' -name 'LEWebApplicationDetails' {
    Context 'LEWebApplicationDetails' {
        It 'Initialize-LELEWebApplicationDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebApplicationDetails -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE"
            #$NewObject | Should -BeOfType WebApplicationDetails
