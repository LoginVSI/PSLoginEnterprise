...
Describe -tag 'PSLoginEnterprise' -name 'LETimeSlot' {
    Context 'LETimeSlot' {
        It 'Initialize-LELETimeSlot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETimeSlot -OffsetInMinutes "TEST_VALUE" -TestRunResults "TEST_VALUE"
            #$NewObject | Should -BeOfType TimeSlot
