...
Describe -tag 'PSLoginEnterprise' -name 'LETestRunResults' {
    Context 'LETestRunResults' {
        It 'Initialize-LELETestRunResults' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestRunResults -TestRunId "TEST_VALUE" -TestName "TEST_VALUE" -Counter "TEST_VALUE" -IsBase "TEST_VALUE" -State "TEST_VALUE" -TestResult "TEST_VALUE" -Results "TEST_VALUE"
            #$NewObject | Should -BeOfType TestRunResults
