...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestUpdate' {
    Context 'LEApplicationTestUpdate' {
        It 'Initialize-LELEApplicationTestUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -ConnectionResourcesUpdate "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Steps "TEST_VALUE" -LogonTimeTrackingProcess "TEST_VALUE" -EngineStartTimeout "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -IsEmailEnabled "TEST_VALUE" -EmailRecipient "TEST_VALUE" -IncludeSuccessfulApplications "TEST_VALUE" -RestartOnComplete "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestUpdate
