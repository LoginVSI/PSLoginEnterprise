...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxScore' {
    Context 'LEEuxScore' {
        It 'Initialize-LELEEuxScore' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxScore -Score "TEST_VALUE" -SteadyStateScore "TEST_VALUE" -Baseline "TEST_VALUE" -BaselineStartMinute "TEST_VALUE" -BaselineWindowSize "TEST_VALUE" -Version "TEST_VALUE" -State "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxScore
