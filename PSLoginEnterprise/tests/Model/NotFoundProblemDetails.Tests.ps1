...
Describe -tag 'PSLoginEnterprise' -name 'LENotFoundProblemDetails' {
    Context 'LENotFoundProblemDetails' {
        It 'Initialize-LELENotFoundProblemDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-LELENotFoundProblemDetails -NotFound "TEST_VALUE" -Type "TEST_VALUE" -Title "TEST_VALUE" -Status "TEST_VALUE" -Detail "TEST_VALUE" -Instance "TEST_VALUE"
            #$NewObject | Should -BeOfType NotFoundProblemDetails
