...
Describe -tag 'PSLoginEnterprise' -name 'LEWmiQueryDefinitionCreate' {
    Context 'LEWmiQueryDefinitionCreate' {
        It 'Initialize-LELEWmiQueryDefinitionCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWmiQueryDefinitionCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE" -WmiQuery "TEST_VALUE" -Namespace "TEST_VALUE" -InstanceField "TEST_VALUE" -Measurements "TEST_VALUE"
            #$NewObject | Should -BeOfType WmiQueryDefinitionCreate
