...
Describe -tag 'PSLoginEnterprise' -name 'LEApplianceHealthMetricSeries' {
    Context 'LEApplianceHealthMetricSeries' {
        It 'Initialize-LELEApplianceHealthMetricSeries' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplianceHealthMetricSeries -MetricId "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE" -DataPoints "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplianceHealthMetricSeries
