...
Describe -tag 'PSLoginEnterprise' -name 'LEDelay' {
    Context 'LEDelay' {
        It 'Initialize-LELEDelay' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDelay -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -DelayInSeconds "TEST_VALUE"
            #$NewObject | Should -BeOfType Delay
