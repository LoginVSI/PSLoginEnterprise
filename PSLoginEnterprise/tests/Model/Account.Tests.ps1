...
Describe -tag 'PSLoginEnterprise' -name 'LEAccount' {
    Context 'LEAccount' {
        It 'Initialize-LELEAccount' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccount -Id "TEST_VALUE" -Username "TEST_VALUE" -Domain "TEST_VALUE" -Email "TEST_VALUE" -Created "TEST_VALUE" -Groups "TEST_VALUE" -Fields "TEST_VALUE" -InUse "TEST_VALUE" -Enabled "TEST_VALUE"
