...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricDefinitionGroupUpdate' {
    Context 'LESessionMetricDefinitionGroupUpdate' {
        It 'Initialize-LELESessionMetricDefinitionGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricDefinitionGroupUpdate -Name "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType SessionMetricDefinitionGroupUpdate
