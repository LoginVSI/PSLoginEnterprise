...
Describe -tag 'PSLoginEnterprise' -name 'LELocationSortKey' {
    Context 'LELocationSortKey' {
        It 'Initialize-LELELocationSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELocationSortKey
            #$NewObject | Should -BeOfType LocationSortKey
