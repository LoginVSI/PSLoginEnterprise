...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricsAggregatedResult' {
    Context 'LEUserSessionMetricsAggregatedResult' {
        It 'Initialize-LELEUserSessionMetricsAggregatedResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricsAggregatedResult -Timestamp "TEST_VALUE" -MetricId "TEST_VALUE" -Measurement "TEST_VALUE" -Count "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionMetricsAggregatedResult
