...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountFilterGroup' {
    Context 'LEAccountFilterGroup' {
        It 'Initialize-LELEAccountFilterGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountFilterGroup -Type "TEST_VALUE" -GroupId "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Members "TEST_VALUE" -VarFilter "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountFilterGroup
