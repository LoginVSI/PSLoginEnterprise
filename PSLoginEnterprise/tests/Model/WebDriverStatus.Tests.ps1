...
Describe -tag 'PSLoginEnterprise' -name 'LEWebDriverStatus' {
    Context 'LEWebDriverStatus' {
        It 'Initialize-LELEWebDriverStatus' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebDriverStatus -Browser "TEST_VALUE" -Current "TEST_VALUE" -AvailableForDownload "TEST_VALUE" -VarError "TEST_VALUE" -IsSuccessful "TEST_VALUE"
            #$NewObject | Should -BeOfType WebDriverStatus
