...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestCreate' {
    Context 'LEApplicationTestCreate' {
        It 'Initialize-LELEApplicationTestCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Connector "TEST_VALUE" -AccountGroups "TEST_VALUE" -LauncherGroups "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -Roles "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestCreate
