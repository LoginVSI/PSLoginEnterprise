...
Describe -tag 'PSLoginEnterprise' -name 'LEMeasurementResultSet' {
    Context 'LEMeasurementResultSet' {
        It 'Initialize-LELEMeasurementResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEMeasurementResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType MeasurementResultSet
