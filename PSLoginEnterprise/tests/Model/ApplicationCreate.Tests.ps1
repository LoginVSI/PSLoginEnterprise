...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationCreate' {
    Context 'LEApplicationCreate' {
        It 'Initialize-LELEApplicationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE" -Roles "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationCreate
