...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroupMemberEnabledUpdate' {
    Context 'LEAccountGroupMemberEnabledUpdate' {
        It 'Initialize-LELEAccountGroupMemberEnabledUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroupMemberEnabledUpdate -GroupIds "TEST_VALUE" -Enabled "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountGroupMemberEnabledUpdate
