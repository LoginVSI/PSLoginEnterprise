...
Describe -tag 'PSLoginEnterprise' -name 'LELoadTestResult' {
    Context 'LELoadTestResult' {
        It 'Initialize-LELELoadTestResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELoadTestResult
            #$NewObject | Should -BeOfType LoadTestResult
