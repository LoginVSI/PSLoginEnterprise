...
Describe -tag 'PSLoginEnterprise' -name 'LEAppGroupReference' {
    Context 'LEAppGroupReference' {
        It 'Initialize-LELEAppGroupReference' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppGroupReference -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -ApplicationGroup "TEST_VALUE"
            #$NewObject | Should -BeOfType AppGroupReference
