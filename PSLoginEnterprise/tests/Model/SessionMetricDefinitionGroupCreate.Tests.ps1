...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricDefinitionGroupCreate' {
    Context 'LESessionMetricDefinitionGroupCreate' {
        It 'Initialize-LELESessionMetricDefinitionGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricDefinitionGroupCreate -Name "TEST_VALUE" -Description "TEST_VALUE" -DefinitionKeys "TEST_VALUE"
            #$NewObject | Should -BeOfType SessionMetricDefinitionGroupCreate
