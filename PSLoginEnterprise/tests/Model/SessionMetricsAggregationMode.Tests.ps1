...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricsAggregationMode' {
    Context 'LESessionMetricsAggregationMode' {
        It 'Initialize-LELESessionMetricsAggregationMode' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricsAggregationMode
            #$NewObject | Should -BeOfType SessionMetricsAggregationMode
