...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestRun' {
    Context 'LEApplicationTestRun' {
        It 'Initialize-LELEApplicationTestRun' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestRun -Type "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -Created "TEST_VALUE" -Started "TEST_VALUE" -Finished "TEST_VALUE" -Counter "TEST_VALUE" -NumberOfEvents "TEST_VALUE" -TestRunConfigurationSnapshot "TEST_VALUE" -State "TEST_VALUE" -Result "TEST_VALUE" -ProductVersion "TEST_VALUE" -AppFailureResults "TEST_VALUE" -AppPerformanceResults "TEST_VALUE" -Properties "TEST_VALUE" -Comment "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestRun
