...
Describe -tag 'PSLoginEnterprise' -name 'LERole' {
    Context 'LERole' {
        It 'Initialize-LELERole' {
            # a simple test to create an object
            #$NewObject = Initialize-LELERole -Id "TEST_VALUE" -Name "TEST_VALUE" -CreatedTime "TEST_VALUE" -LastModifiedTime "TEST_VALUE" -Users "TEST_VALUE" -LdapGroups "TEST_VALUE" -Permissions "TEST_VALUE"
