...
Describe -tag 'PSLoginEnterprise' -name 'LEScreenshotType' {
    Context 'LEScreenshotType' {
        It 'Initialize-LELEScreenshotType' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEScreenshotType
            #$NewObject | Should -BeOfType ScreenshotType
