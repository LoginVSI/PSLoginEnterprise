...
Describe -tag 'PSLoginEnterprise' -name 'LELdapGroupCreate' {
    Context 'LELdapGroupCreate' {
        It 'Initialize-LELELdapGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELdapGroupCreate -DisplayName "TEST_VALUE" -GroupIdentity "TEST_VALUE" -RoleIds "TEST_VALUE"
            #$NewObject | Should -BeOfType LdapGroupCreate
