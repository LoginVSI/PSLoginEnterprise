...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherSelectionGroup' {
    Context 'LELauncherSelectionGroup' {
        It 'Initialize-LELELauncherSelectionGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherSelectionGroup -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Members "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherSelectionGroup
