...
Describe -tag 'PSLoginEnterprise' -name 'LEAppExecutionResultSet' {
    Context 'LEAppExecutionResultSet' {
        It 'Initialize-LELEAppExecutionResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppExecutionResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType AppExecutionResultSet
