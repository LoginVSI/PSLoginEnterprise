...
Describe -tag 'PSLoginEnterprise' -name 'LEConnectionResources' {
    Context 'LEConnectionResources' {
        It 'Initialize-LELEConnectionResources' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConnectionResources -Connector "TEST_VALUE" -LauncherGroups "TEST_VALUE" -AccountGroups "TEST_VALUE"
            #$NewObject | Should -BeOfType ConnectionResources
