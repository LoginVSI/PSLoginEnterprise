...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroupInclude' {
    Context 'LEApplicationGroupInclude' {
        It 'Initialize-LELEApplicationGroupInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroupInclude
            #$NewObject | Should -BeOfType ApplicationGroupInclude
