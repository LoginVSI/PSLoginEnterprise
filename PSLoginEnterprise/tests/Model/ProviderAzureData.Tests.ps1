...
Describe -tag 'PSLoginEnterprise' -name 'LEProviderAzureData' {
    Context 'LEProviderAzureData' {
        It 'Initialize-LELEProviderAzureData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProviderAzureData -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -TenantId "TEST_VALUE" -ApplicationId "TEST_VALUE" -Secret "TEST_VALUE"
            #$NewObject | Should -BeOfType ProviderAzureData
