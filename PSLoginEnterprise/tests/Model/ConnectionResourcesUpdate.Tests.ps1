...
Describe -tag 'PSLoginEnterprise' -name 'LEConnectionResourcesUpdate' {
    Context 'LEConnectionResourcesUpdate' {
        It 'Initialize-LELEConnectionResourcesUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConnectionResourcesUpdate -Connector "TEST_VALUE" -LauncherGroups "TEST_VALUE" -AccountGroups "TEST_VALUE"
            #$NewObject | Should -BeOfType ConnectionResourcesUpdate
