...
Describe -tag 'PSLoginEnterprise' -name 'LENotificationEventType' {
    Context 'LENotificationEventType' {
        It 'Initialize-LELENotificationEventType' {
            # a simple test to create an object
            #$NewObject = Initialize-LELENotificationEventType
            #$NewObject | Should -BeOfType NotificationEventType
