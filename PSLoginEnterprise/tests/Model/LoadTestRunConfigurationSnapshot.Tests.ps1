...
Describe -tag 'PSLoginEnterprise' -name 'LELoadTestRunConfigurationSnapshot' {
    Context 'LELoadTestRunConfigurationSnapshot' {
        It 'Initialize-LELELoadTestRunConfigurationSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELoadTestRunConfigurationSnapshot -EnvironmentKey "TEST_VALUE" -EnvironmentName "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -RampUpDurationInMinutes "TEST_VALUE" -RampDownDurationInMinutes "TEST_VALUE" -TestDurationInMinutes "TEST_VALUE" -EuxEnabled "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -SessionMetricsEnabled "TEST_VALUE" -SessionMetricScheduleRate "TEST_VALUE" -TestId "TEST_VALUE" -Name "TEST_VALUE" -Workload "TEST_VALUE" -Connector "TEST_VALUE" -LauncherGroups "TEST_VALUE" -AccountGroups "TEST_VALUE" -SessionMetricDefinition "TEST_VALUE"
            #$NewObject | Should -BeOfType LoadTestRunConfigurationSnapshot
