...
Describe -tag 'PSLoginEnterprise' -name 'LETestSortKey' {
    Context 'LETestSortKey' {
        It 'Initialize-LELETestSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestSortKey
            #$NewObject | Should -BeOfType TestSortKey
