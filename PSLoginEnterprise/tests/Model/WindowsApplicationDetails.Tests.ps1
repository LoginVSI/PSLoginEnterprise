...
Describe -tag 'PSLoginEnterprise' -name 'LEWindowsApplicationDetails' {
    Context 'LEWindowsApplicationDetails' {
        It 'Initialize-LELEWindowsApplicationDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWindowsApplicationDetails -Type "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
            #$NewObject | Should -BeOfType WindowsApplicationDetails
