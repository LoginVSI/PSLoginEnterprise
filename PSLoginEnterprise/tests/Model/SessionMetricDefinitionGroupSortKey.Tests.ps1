...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricDefinitionGroupSortKey' {
    Context 'LESessionMetricDefinitionGroupSortKey' {
        It 'Initialize-LELESessionMetricDefinitionGroupSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricDefinitionGroupSortKey
            #$NewObject | Should -BeOfType SessionMetricDefinitionGroupSortKey
