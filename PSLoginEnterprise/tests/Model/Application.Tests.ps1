...
Describe -tag 'PSLoginEnterprise' -name 'LEApplication' {
    Context 'LEApplication' {
        It 'Initialize-LELEApplication' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplication -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Script "TEST_VALUE" -Timers "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -HasPassword "TEST_VALUE"
