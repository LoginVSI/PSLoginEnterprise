...
Describe -tag 'PSLoginEnterprise' -name 'LERoleResultSet' {
    Context 'LERoleResultSet' {
        It 'Initialize-LELERoleResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELERoleResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType RoleResultSet
