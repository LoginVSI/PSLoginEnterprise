...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroupUpdate' {
    Context 'LEApplicationGroupUpdate' {
        It 'Initialize-LELEApplicationGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroupUpdate -Name "TEST_VALUE" -Description "TEST_VALUE" -Steps "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationGroupUpdate
