...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherLocationUpdate' {
    Context 'LELauncherLocationUpdate' {
        It 'Initialize-LELELauncherLocationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherLocationUpdate -LocationId "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherLocationUpdate
