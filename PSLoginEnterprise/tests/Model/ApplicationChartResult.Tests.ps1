...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationChartResult' {
    Context 'LEApplicationChartResult' {
        It 'Initialize-LELEApplicationChartResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationChartResult -ApplicationId "TEST_VALUE" -ApplicationName "TEST_VALUE" -TestRunsInfo "TEST_VALUE" -TimeSlots "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationChartResult
