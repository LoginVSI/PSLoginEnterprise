...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroupInclude' {
    Context 'LEAccountGroupInclude' {
        It 'Initialize-LELEAccountGroupInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroupInclude
            #$NewObject | Should -BeOfType AccountGroupInclude
