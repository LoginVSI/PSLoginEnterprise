...
Describe -tag 'PSLoginEnterprise' -name 'LETestRunResult' {
    Context 'LETestRunResult' {
        It 'Initialize-LELETestRunResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestRunResult -TestRunId "TEST_VALUE" -ChartMetricResults "TEST_VALUE"
            #$NewObject | Should -BeOfType TestRunResult
