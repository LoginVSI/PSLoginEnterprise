...
Describe -tag 'PSLoginEnterprise' -name 'LEEventResultSet' {
    Context 'LEEventResultSet' {
        It 'Initialize-LELEEventResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEventResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType EventResultSet
