...
Describe -tag 'PSLoginEnterprise' -name 'LEPerformanceResult' {
    Context 'LEPerformanceResult' {
        It 'Initialize-LELEPerformanceResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPerformanceResult -Duration "TEST_VALUE" -Threshold "TEST_VALUE" -DurationDifference "TEST_VALUE" -ThresholdDifference "TEST_VALUE" -IsSuccessful "TEST_VALUE"
            #$NewObject | Should -BeOfType PerformanceResult
