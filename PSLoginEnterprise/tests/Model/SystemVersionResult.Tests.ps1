...
Describe -tag 'PSLoginEnterprise' -name 'LESystemVersionResult' {
    Context 'LESystemVersionResult' {
        It 'Initialize-LELESystemVersionResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESystemVersionResult -CurrentVersion "TEST_VALUE" -LatestVersion "TEST_VALUE"
            #$NewObject | Should -BeOfType SystemVersionResult
