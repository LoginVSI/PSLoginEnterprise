...
Describe -tag 'PSLoginEnterprise' -name 'LEAddPlatformMetricsResult' {
    Context 'LEAddPlatformMetricsResult' {
        It 'Initialize-LELEAddPlatformMetricsResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAddPlatformMetricsResult -Status "TEST_VALUE" -SuccessfullyAddedCount "TEST_VALUE" -Errors "TEST_VALUE"
            #$NewObject | Should -BeOfType AddPlatformMetricsResult
