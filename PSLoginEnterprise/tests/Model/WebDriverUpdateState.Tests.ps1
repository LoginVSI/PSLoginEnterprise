...
Describe -tag 'PSLoginEnterprise' -name 'LEWebDriverUpdateState' {
    Context 'LEWebDriverUpdateState' {
        It 'Initialize-LELEWebDriverUpdateState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebDriverUpdateState
            #$NewObject | Should -BeOfType WebDriverUpdateState
