...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxResultsPerHour' {
    Context 'LEEuxResultsPerHour' {
        It 'Initialize-LELEEuxResultsPerHour' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxResultsPerHour -Timestamp "TEST_VALUE" -Score "TEST_VALUE" -Count "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxResultsPerHour
