...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountFilterGroupCreate' {
    Context 'LEAccountFilterGroupCreate' {
        It 'Initialize-LELEAccountFilterGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountFilterGroupCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -VarFilter "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountFilterGroupCreate
