...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroupAccessBulkUpdate' {
    Context 'LEApplicationGroupAccessBulkUpdate' {
        It 'Initialize-LELEApplicationGroupAccessBulkUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroupAccessBulkUpdate -ApplicationGroupIds "TEST_VALUE" -RoleIds "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationGroupAccessBulkUpdate
