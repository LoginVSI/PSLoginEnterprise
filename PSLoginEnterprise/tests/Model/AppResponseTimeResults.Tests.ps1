...
Describe -tag 'PSLoginEnterprise' -name 'LEAppResponseTimeResults' {
    Context 'LEAppResponseTimeResults' {
        It 'Initialize-LELEAppResponseTimeResults' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppResponseTimeResults -AppId "TEST_VALUE" -AppName "TEST_VALUE" -Results "TEST_VALUE"
            #$NewObject | Should -BeOfType AppResponseTimeResults
