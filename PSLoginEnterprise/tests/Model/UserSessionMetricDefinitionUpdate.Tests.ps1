...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricDefinitionUpdate' {
    Context 'LEUserSessionMetricDefinitionUpdate' {
        It 'Initialize-LELEUserSessionMetricDefinitionUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricDefinitionUpdate -Name "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionMetricDefinitionUpdate
