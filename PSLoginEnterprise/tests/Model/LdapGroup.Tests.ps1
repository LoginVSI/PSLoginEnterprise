...
Describe -tag 'PSLoginEnterprise' -name 'LELdapGroup' {
    Context 'LELdapGroup' {
        It 'Initialize-LELELdapGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELdapGroup -Id "TEST_VALUE" -DisplayName "TEST_VALUE" -GroupIdentity "TEST_VALUE" -CreatedTime "TEST_VALUE" -LastModifiedTime "TEST_VALUE" -Roles "TEST_VALUE"
            #$NewObject | Should -BeOfType LdapGroup
