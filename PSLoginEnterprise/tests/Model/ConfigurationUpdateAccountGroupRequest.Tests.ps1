...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationUpdateAccountGroupRequest' {
    Context 'LEConfigurationUpdateAccountGroupRequest' {
        It 'Initialize-LELEConfigurationUpdateAccountGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationUpdateAccountGroupRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -VarFilter "TEST_VALUE" -MemberIds "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationUpdateAccountGroupRequest
