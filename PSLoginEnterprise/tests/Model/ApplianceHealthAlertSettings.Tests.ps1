...
Describe -tag 'PSLoginEnterprise' -name 'LEApplianceHealthAlertSettings' {
    Context 'LEApplianceHealthAlertSettings' {
        It 'Initialize-LELEApplianceHealthAlertSettings' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplianceHealthAlertSettings -EmailNotificationEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -EmailCooldownHours "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplianceHealthAlertSettings
