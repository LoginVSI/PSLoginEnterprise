...
Describe -tag 'PSLoginEnterprise' -name 'LELdapConfigModel' {
    Context 'LELdapConfigModel' {
        It 'Initialize-LELELdapConfigModel' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELdapConfigModel -VarHost "TEST_VALUE" -Port "TEST_VALUE" -Secured "TEST_VALUE" -IgnoreSslErrors "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -Domain "TEST_VALUE" -ConnectionTimeout "TEST_VALUE"
            #$NewObject | Should -BeOfType LdapConfigModel
