...
Describe -tag 'PSLoginEnterprise' -name 'LEProviderResultSet' {
    Context 'LEProviderResultSet' {
        It 'Initialize-LELEProviderResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProviderResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType ProviderResultSet
