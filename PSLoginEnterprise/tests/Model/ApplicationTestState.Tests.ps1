...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestState' {
    Context 'LEApplicationTestState' {
        It 'Initialize-LELEApplicationTestState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestState
            #$NewObject | Should -BeOfType ApplicationTestState
