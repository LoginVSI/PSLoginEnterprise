...
Describe -tag 'PSLoginEnterprise' -name 'LELocationCreate' {
    Context 'LELocationCreate' {
        It 'Initialize-LELELocationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELocationCreate -Name "TEST_VALUE" -Latitude "TEST_VALUE" -Longitude "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType LocationCreate
