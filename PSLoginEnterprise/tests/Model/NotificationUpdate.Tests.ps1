...
Describe -tag 'PSLoginEnterprise' -name 'LENotificationUpdate' {
    Context 'LENotificationUpdate' {
        It 'Initialize-LELENotificationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELENotificationUpdate -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE"
            #$NewObject | Should -BeOfType NotificationUpdate
