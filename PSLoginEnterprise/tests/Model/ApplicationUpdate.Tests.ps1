...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationUpdate' {
    Context 'LEApplicationUpdate' {
        It 'Initialize-LELEApplicationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -MustUpdatePassword "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationUpdate
