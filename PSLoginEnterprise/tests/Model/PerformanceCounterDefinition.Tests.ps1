...
Describe -tag 'PSLoginEnterprise' -name 'LEPerformanceCounterDefinition' {
    Context 'LEPerformanceCounterDefinition' {
        It 'Initialize-LELEPerformanceCounterDefinition' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPerformanceCounterDefinition -Type "TEST_VALUE" -Key "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE" -Measurement "TEST_VALUE"
            #$NewObject | Should -BeOfType PerformanceCounterDefinition
