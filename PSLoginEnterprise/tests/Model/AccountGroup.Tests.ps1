...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroup' {
    Context 'LEAccountGroup' {
        It 'Initialize-LELEAccountGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroup -Type "TEST_VALUE" -GroupId "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Members "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountGroup
