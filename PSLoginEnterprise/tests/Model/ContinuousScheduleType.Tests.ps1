...
Describe -tag 'PSLoginEnterprise' -name 'LEContinuousScheduleType' {
    Context 'LEContinuousScheduleType' {
        It 'Initialize-LELEContinuousScheduleType' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEContinuousScheduleType
            #$NewObject | Should -BeOfType ContinuousScheduleType
