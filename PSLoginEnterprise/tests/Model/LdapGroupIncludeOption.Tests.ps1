...
Describe -tag 'PSLoginEnterprise' -name 'LELdapGroupIncludeOption' {
    Context 'LELdapGroupIncludeOption' {
        It 'Initialize-LELELdapGroupIncludeOption' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELdapGroupIncludeOption
            #$NewObject | Should -BeOfType LdapGroupIncludeOption
