...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestResult' {
    Context 'LEApplicationTestResult' {
        It 'Initialize-LELEApplicationTestResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestResult
            #$NewObject | Should -BeOfType ApplicationTestResult
