...
Describe -tag 'PSLoginEnterprise' -name 'LEThresholdNotificationUpdate' {
    Context 'LEThresholdNotificationUpdate' {
        It 'Initialize-LELEThresholdNotificationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEThresholdNotificationUpdate -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE" -ThresholdUpdate "TEST_VALUE"
            #$NewObject | Should -BeOfType ThresholdNotificationUpdate
