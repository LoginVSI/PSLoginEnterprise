...
Describe -tag 'PSLoginEnterprise' -name 'LETestRunSortKey' {
    Context 'LETestRunSortKey' {
        It 'Initialize-LELETestRunSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestRunSortKey
            #$NewObject | Should -BeOfType TestRunSortKey
