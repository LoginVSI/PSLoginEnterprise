...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionResultSet' {
    Context 'LEUserSessionResultSet' {
        It 'Initialize-LELEUserSessionResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionResultSet
