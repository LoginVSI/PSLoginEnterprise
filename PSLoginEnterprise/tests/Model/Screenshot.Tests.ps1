...
Describe -tag 'PSLoginEnterprise' -name 'LEScreenshot' {
    Context 'LEScreenshot' {
        It 'Initialize-LELEScreenshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEScreenshot -Id "TEST_VALUE" -Created "TEST_VALUE"
            #$NewObject | Should -BeOfType Screenshot
