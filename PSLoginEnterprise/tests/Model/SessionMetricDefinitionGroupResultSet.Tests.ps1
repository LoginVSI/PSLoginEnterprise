...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricDefinitionGroupResultSet' {
    Context 'LESessionMetricDefinitionGroupResultSet' {
        It 'Initialize-LELESessionMetricDefinitionGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricDefinitionGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType SessionMetricDefinitionGroupResultSet
