...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationUpdateApplicationRequest' {
    Context 'LEConfigurationUpdateApplicationRequest' {
        It 'Initialize-LELEConfigurationUpdateApplicationRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationUpdateApplicationRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -MustUpdatePassword "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationUpdateApplicationRequest
