...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxMeasurement' {
    Context 'LEEuxMeasurement' {
        It 'Initialize-LELEEuxMeasurement' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxMeasurement -Timestamp "TEST_VALUE" -Timer "TEST_VALUE" -Duration "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxMeasurement
