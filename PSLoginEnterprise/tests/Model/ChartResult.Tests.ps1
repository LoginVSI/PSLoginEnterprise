...
Describe -tag 'PSLoginEnterprise' -name 'LEChartResult' {
    Context 'LEChartResult' {
        It 'Initialize-LELEChartResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEChartResult -TestRunsInfo "TEST_VALUE" -TimeSlots "TEST_VALUE"
            #$NewObject | Should -BeOfType ChartResult
