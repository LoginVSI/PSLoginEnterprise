...
Describe -tag 'PSLoginEnterprise' -name 'LEThresholdUpdate' {
    Context 'LEThresholdUpdate' {
        It 'Initialize-LELEThresholdUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEThresholdUpdate -IsEnabled "TEST_VALUE" -Value "TEST_VALUE"
            #$NewObject | Should -BeOfType ThresholdUpdate
