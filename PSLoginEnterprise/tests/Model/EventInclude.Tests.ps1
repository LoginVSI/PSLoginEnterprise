...
Describe -tag 'PSLoginEnterprise' -name 'LEEventInclude' {
    Context 'LEEventInclude' {
        It 'Initialize-LELEEventInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEventInclude
            #$NewObject | Should -BeOfType EventInclude
