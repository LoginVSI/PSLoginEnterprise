...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroupUpdate' {
    Context 'LEAccountGroupUpdate' {
        It 'Initialize-LELEAccountGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroupUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountGroupUpdate
