...
Describe -tag 'PSLoginEnterprise' -name 'LETestRunInfo' {
    Context 'LETestRunInfo' {
        It 'Initialize-LELETestRunInfo' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestRunInfo -TestRunId "TEST_VALUE" -TestName "TEST_VALUE" -TestCounter "TEST_VALUE" -RampUpCompletedMinute "TEST_VALUE" -VsiMaxReachedAt "TEST_VALUE" -ActualVsiMax "TEST_VALUE"
            #$NewObject | Should -BeOfType TestRunInfo
