...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountFilterGroupUpdate' {
    Context 'LEAccountFilterGroupUpdate' {
        It 'Initialize-LELEAccountFilterGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountFilterGroupUpdate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -VarFilter "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountFilterGroupUpdate
