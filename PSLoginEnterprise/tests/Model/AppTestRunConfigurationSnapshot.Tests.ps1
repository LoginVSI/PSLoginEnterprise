...
Describe -tag 'PSLoginEnterprise' -name 'LEAppTestRunConfigurationSnapshot' {
    Context 'LEAppTestRunConfigurationSnapshot' {
        It 'Initialize-LELEAppTestRunConfigurationSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppTestRunConfigurationSnapshot -RestartOnComplete "TEST_VALUE" -IncludeSuccessfulApplications "TEST_VALUE" -IsEmailEnabled "TEST_VALUE" -EmailRecipient "TEST_VALUE" -Thresholds "TEST_VALUE" -TestId "TEST_VALUE" -Name "TEST_VALUE" -Workload "TEST_VALUE" -Connector "TEST_VALUE" -LauncherGroups "TEST_VALUE" -AccountGroups "TEST_VALUE" -SessionMetricDefinition "TEST_VALUE"
            #$NewObject | Should -BeOfType AppTestRunConfigurationSnapshot
