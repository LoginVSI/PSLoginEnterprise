...
Describe -tag 'PSLoginEnterprise' -name 'LEProviderData' {
    Context 'LEProviderData' {
        It 'Initialize-LELEProviderData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProviderData -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType ProviderData
