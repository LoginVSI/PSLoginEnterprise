...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricResultResultSet' {
    Context 'LEUserSessionMetricResultResultSet' {
        It 'Initialize-LELEUserSessionMetricResultResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricResultResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionMetricResultResultSet
