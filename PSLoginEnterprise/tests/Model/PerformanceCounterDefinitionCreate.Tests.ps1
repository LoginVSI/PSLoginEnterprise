...
Describe -tag 'PSLoginEnterprise' -name 'LEPerformanceCounterDefinitionCreate' {
    Context 'LEPerformanceCounterDefinitionCreate' {
        It 'Initialize-LELEPerformanceCounterDefinitionCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPerformanceCounterDefinitionCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE" -Measurement "TEST_VALUE"
            #$NewObject | Should -BeOfType PerformanceCounterDefinitionCreate
