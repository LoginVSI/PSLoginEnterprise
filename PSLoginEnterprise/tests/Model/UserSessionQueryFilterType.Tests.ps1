...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionQueryFilterType' {
    Context 'LEUserSessionQueryFilterType' {
        It 'Initialize-LELEUserSessionQueryFilterType' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionQueryFilterType
            #$NewObject | Should -BeOfType UserSessionQueryFilterType
