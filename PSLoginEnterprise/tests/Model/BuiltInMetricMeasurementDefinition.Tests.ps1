...
Describe -tag 'PSLoginEnterprise' -name 'LEBuiltInMetricMeasurementDefinition' {
    Context 'LEBuiltInMetricMeasurementDefinition' {
        It 'Initialize-LELEBuiltInMetricMeasurementDefinition' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEBuiltInMetricMeasurementDefinition -MetricId "TEST_VALUE" -Key "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE"
            #$NewObject | Should -BeOfType BuiltInMetricMeasurementDefinition
