...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationAccessBulkUpdate' {
    Context 'LEApplicationAccessBulkUpdate' {
        It 'Initialize-LELEApplicationAccessBulkUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationAccessBulkUpdate -ApplicationIds "TEST_VALUE" -RoleIds "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationAccessBulkUpdate
