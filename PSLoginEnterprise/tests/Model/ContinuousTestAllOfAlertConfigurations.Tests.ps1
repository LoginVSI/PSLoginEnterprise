...
Describe -tag 'PSLoginEnterprise' -name 'LEContinuousTestAllOfAlertConfigurations' {
    Context 'LEContinuousTestAllOfAlertConfigurations' {
        It 'Initialize-LELEContinuousTestAllOfAlertConfigurations' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEContinuousTestAllOfAlertConfigurations -Type "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE" -Threshold "TEST_VALUE" -VarEvent "TEST_VALUE" -LastModified "TEST_VALUE"
            #$NewObject | Should -BeOfType ContinuousTestAllOfAlertConfigurations
