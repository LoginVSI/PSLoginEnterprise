...
Describe -tag 'PSLoginEnterprise' -name 'LETestControlState' {
    Context 'LETestControlState' {
        It 'Initialize-LELETestControlState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestControlState
            #$NewObject | Should -BeOfType TestControlState
