...
Describe -tag 'PSLoginEnterprise' -name 'LEChartMetricResult' {
    Context 'LEChartMetricResult' {
        It 'Initialize-LELEChartMetricResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEChartMetricResult -MetricId "TEST_VALUE" -Value "TEST_VALUE"
            #$NewObject | Should -BeOfType ChartMetricResult
