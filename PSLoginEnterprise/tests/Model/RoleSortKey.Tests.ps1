...
Describe -tag 'PSLoginEnterprise' -name 'LERoleSortKey' {
    Context 'LERoleSortKey' {
        It 'Initialize-LELERoleSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELERoleSortKey
            #$NewObject | Should -BeOfType RoleSortKey
