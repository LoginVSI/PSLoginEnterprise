...
Describe -tag 'PSLoginEnterprise' -name 'LEAppExecutionState' {
    Context 'LEAppExecutionState' {
        It 'Initialize-LELEAppExecutionState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppExecutionState
            #$NewObject | Should -BeOfType AppExecutionState
