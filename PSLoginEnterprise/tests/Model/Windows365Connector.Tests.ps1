...
Describe -tag 'PSLoginEnterprise' -name 'Windows365Connector' {
    Context 'Windows365Connector' {
        It 'Initialize-Windows365Connector' {
            # a simple test to create an object
            #$NewObject = Initialize-Windows365Connector -Type "TEST_VALUE" -CloudPcTitleField "TEST_VALUE" -TotpSecretSecureField "TEST_VALUE" -TimeoutSeconds "TEST_VALUE" -TotpTimeStep "TEST_VALUE" -TotpDigits "TEST_VALUE" -TotpAlgorithm "TEST_VALUE"
            #$NewObject | Should -BeOfType Windows365Connector
