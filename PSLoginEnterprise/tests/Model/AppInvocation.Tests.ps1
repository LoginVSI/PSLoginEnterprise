...
Describe -tag 'PSLoginEnterprise' -name 'LEAppInvocation' {
    Context 'LEAppInvocation' {
        It 'Initialize-LELEAppInvocation' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppInvocation -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Application "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE"
            #$NewObject | Should -BeOfType AppInvocation
