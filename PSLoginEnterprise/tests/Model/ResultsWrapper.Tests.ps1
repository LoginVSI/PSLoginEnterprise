...
Describe -tag 'PSLoginEnterprise' -name 'LEResultsWrapper' {
    Context 'LEResultsWrapper' {
        It 'Initialize-LELEResultsWrapper' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEResultsWrapper -LoginTime "TEST_VALUE" -Performance "TEST_VALUE" -AppPerformanceResult "TEST_VALUE"
            #$NewObject | Should -BeOfType ResultsWrapper
