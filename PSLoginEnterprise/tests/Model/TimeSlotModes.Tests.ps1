...
Describe -tag 'PSLoginEnterprise' -name 'LETimeSlotModes' {
    Context 'LETimeSlotModes' {
        It 'Initialize-LELETimeSlotModes' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETimeSlotModes
            #$NewObject | Should -BeOfType TimeSlotModes
