...
Describe -tag 'PSLoginEnterprise' -name 'LECustomConnector' {
    Context 'LECustomConnector' {
        It 'Initialize-LELECustomConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELECustomConnector -Type "TEST_VALUE" -VarHost "TEST_VALUE" -CommandLine "TEST_VALUE" -Resource "TEST_VALUE"
            #$NewObject | Should -BeOfType CustomConnector
