...
Describe -tag 'PSLoginEnterprise' -name 'LEAppGroupReferenceUpdate' {
    Context 'LEAppGroupReferenceUpdate' {
        It 'Initialize-LELEAppGroupReferenceUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppGroupReferenceUpdate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE"
            #$NewObject | Should -BeOfType AppGroupReferenceUpdate
