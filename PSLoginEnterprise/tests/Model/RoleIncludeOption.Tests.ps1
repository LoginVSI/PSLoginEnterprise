...
Describe -tag 'PSLoginEnterprise' -name 'LERoleIncludeOption' {
    Context 'LERoleIncludeOption' {
        It 'Initialize-LELERoleIncludeOption' {
            # a simple test to create an object
            #$NewObject = Initialize-LELERoleIncludeOption
            #$NewObject | Should -BeOfType RoleIncludeOption
