...
Describe -tag 'PSLoginEnterprise' -name 'LEContinuousTestBulkUpdateResponse' {
    Context 'LEContinuousTestBulkUpdateResponse' {
        It 'Initialize-LELEContinuousTestBulkUpdateResponse' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEContinuousTestBulkUpdateResponse -FailedIds "TEST_VALUE"
            #$NewObject | Should -BeOfType ContinuousTestBulkUpdateResponse
