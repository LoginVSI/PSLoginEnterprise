...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherSelectionGroupData' {
    Context 'LELauncherSelectionGroupData' {
        It 'Initialize-LELELauncherSelectionGroupData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherSelectionGroupData -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -LauncherNames "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherSelectionGroupData
