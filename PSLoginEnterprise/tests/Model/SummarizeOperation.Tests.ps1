...
Describe -tag 'PSLoginEnterprise' -name 'LESummarizeOperation' {
    Context 'LESummarizeOperation' {
        It 'Initialize-LELESummarizeOperation' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESummarizeOperation
            #$NewObject | Should -BeOfType SummarizeOperation
