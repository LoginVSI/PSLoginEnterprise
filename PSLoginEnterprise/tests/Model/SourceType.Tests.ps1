...
Describe -tag 'PSLoginEnterprise' -name 'LESourceType' {
    Context 'LESourceType' {
        It 'Initialize-LELESourceType' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESourceType
            #$NewObject | Should -BeOfType SourceType
