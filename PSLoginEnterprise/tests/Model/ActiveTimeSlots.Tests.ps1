...
Describe -tag 'PSLoginEnterprise' -name 'LEActiveTimeSlots' {
    Context 'LEActiveTimeSlots' {
        It 'Initialize-LELEActiveTimeSlots' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEActiveTimeSlots -Mode "TEST_VALUE" -TimeSlots "TEST_VALUE"
            #$NewObject | Should -BeOfType ActiveTimeSlots
