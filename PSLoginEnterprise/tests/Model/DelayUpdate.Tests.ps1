...
Describe -tag 'PSLoginEnterprise' -name 'LEDelayUpdate' {
    Context 'LEDelayUpdate' {
        It 'Initialize-LELEDelayUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDelayUpdate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -DelayInSeconds "TEST_VALUE"
            #$NewObject | Should -BeOfType DelayUpdate
