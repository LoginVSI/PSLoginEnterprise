...
Describe -tag 'PSLoginEnterprise' -name 'LEReportConfigurationInclude' {
    Context 'LEReportConfigurationInclude' {
        It 'Initialize-LELEReportConfigurationInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportConfigurationInclude
            #$NewObject | Should -BeOfType ReportConfigurationInclude
