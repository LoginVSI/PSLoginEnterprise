...
Describe -tag 'PSLoginEnterprise' -name 'LETest' {
    Context 'LETest' {
        It 'Initialize-LELETest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETest -Type "TEST_VALUE" -Id "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -ConnectionResources "TEST_VALUE" -Workload "TEST_VALUE" -LogonTimeTrackingProcess "TEST_VALUE" -EngineStartTimeout "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE"
            #$NewObject | Should -BeOfType Test
