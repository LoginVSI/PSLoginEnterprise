...
Describe -tag 'PSLoginEnterprise' -name 'LEAppGroupSnapshot' {
    Context 'LEAppGroupSnapshot' {
        It 'Initialize-LELEAppGroupSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppGroupSnapshot -Type "TEST_VALUE" -Name "TEST_VALUE" -GroupSteps "TEST_VALUE"
            #$NewObject | Should -BeOfType AppGroupSnapshot
