...
Describe -tag 'PSLoginEnterprise' -name 'LEWmiQueryMeasurementDefinitionCreate' {
    Context 'LEWmiQueryMeasurementDefinitionCreate' {
        It 'Initialize-LELEWmiQueryMeasurementDefinitionCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWmiQueryMeasurementDefinitionCreate -PropertyName "TEST_VALUE" -SummarizeOperation "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE"
            #$NewObject | Should -BeOfType WmiQueryMeasurementDefinitionCreate
