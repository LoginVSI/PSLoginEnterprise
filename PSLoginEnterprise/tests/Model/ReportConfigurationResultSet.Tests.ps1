...
Describe -tag 'PSLoginEnterprise' -name 'LEReportConfigurationResultSet' {
    Context 'LEReportConfigurationResultSet' {
        It 'Initialize-LELEReportConfigurationResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportConfigurationResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType ReportConfigurationResultSet
