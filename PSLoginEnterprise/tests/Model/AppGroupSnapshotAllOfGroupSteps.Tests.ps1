...
Describe -tag 'PSLoginEnterprise' -name 'LEAppGroupSnapshotAllOfGroupSteps' {
    Context 'LEAppGroupSnapshotAllOfGroupSteps' {
        It 'Initialize-LELEAppGroupSnapshotAllOfGroupSteps' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppGroupSnapshotAllOfGroupSteps -Type "TEST_VALUE" -AppId "TEST_VALUE" -ApplicationName "TEST_VALUE" -Timers "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -DelayInSeconds "TEST_VALUE" -Name "TEST_VALUE" -GroupSteps "TEST_VALUE"
            #$NewObject | Should -BeOfType AppGroupSnapshotAllOfGroupSteps
