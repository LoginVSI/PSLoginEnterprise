...
Describe -tag 'PSLoginEnterprise' -name 'LdapConfigModelUpdate' {
    Context 'LdapConfigModelUpdate' {
        It 'Initialize-LdapConfigModelUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LdapConfigModelUpdate -VarHost "TEST_VALUE" -Port "TEST_VALUE" -Secured "TEST_VALUE" -IgnoreSslErrors "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -Domain "TEST_VALUE" -ConnectionTimeout "TEST_VALUE" -StoreCredentials "TEST_VALUE"
            #$NewObject | Should -BeOfType LdapConfigModelUpdate
