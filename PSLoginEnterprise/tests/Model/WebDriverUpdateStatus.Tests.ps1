...
Describe -tag 'PSLoginEnterprise' -name 'LEWebDriverUpdateStatus' {
    Context 'LEWebDriverUpdateStatus' {
        It 'Initialize-LELEWebDriverUpdateStatus' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebDriverUpdateStatus -UpdatesAvailable "TEST_VALUE" -Drivers "TEST_VALUE"
            #$NewObject | Should -BeOfType WebDriverUpdateStatus
