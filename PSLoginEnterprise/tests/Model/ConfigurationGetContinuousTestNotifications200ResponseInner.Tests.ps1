...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationGetContinuousTestNotifications200ResponseInner' {
    Context 'LEConfigurationGetContinuousTestNotifications200ResponseInner' {
        It 'Initialize-LELEConfigurationGetContinuousTestNotifications200ResponseInner' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationGetContinuousTestNotifications200ResponseInner -Type "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE" -Threshold "TEST_VALUE" -VarEvent "TEST_VALUE" -LastModified "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationGetContinuousTestNotifications200ResponseInner
