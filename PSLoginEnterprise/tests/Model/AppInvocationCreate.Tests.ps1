...
Describe -tag 'PSLoginEnterprise' -name 'LEAppInvocationCreate' {
    Context 'LEAppInvocationCreate' {
        It 'Initialize-LELEAppInvocationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppInvocationCreate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -ApplicationId "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE"
            #$NewObject | Should -BeOfType AppInvocationCreate
