...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountBulkCreate' {
    Context 'LEAccountBulkCreate' {
        It 'Initialize-LELEAccountBulkCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountBulkCreate -NumberOfDigits "TEST_VALUE" -NumberOfAccounts "TEST_VALUE" -Username "TEST_VALUE" -Domain "TEST_VALUE" -Email "TEST_VALUE" -Password "TEST_VALUE" -Fields "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountBulkCreate
