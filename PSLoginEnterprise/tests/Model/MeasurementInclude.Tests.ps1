...
Describe -tag 'PSLoginEnterprise' -name 'LEMeasurementInclude' {
    Context 'LEMeasurementInclude' {
        It 'Initialize-LELEMeasurementInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEMeasurementInclude
            #$NewObject | Should -BeOfType MeasurementInclude
