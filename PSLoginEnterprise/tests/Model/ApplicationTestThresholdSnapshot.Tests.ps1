...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestThresholdSnapshot' {
    Context 'LEApplicationTestThresholdSnapshot' {
        It 'Initialize-LELEApplicationTestThresholdSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestThresholdSnapshot -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestThresholdSnapshot
