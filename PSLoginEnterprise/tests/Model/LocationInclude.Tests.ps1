...
Describe -tag 'PSLoginEnterprise' -name 'LELocationInclude' {
    Context 'LELocationInclude' {
        It 'Initialize-LELELocationInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELocationInclude
            #$NewObject | Should -BeOfType LocationInclude
