...
Describe -tag 'PSLoginEnterprise' -name 'LEReportConfigurationUpdate' {
    Context 'LEReportConfigurationUpdate' {
        It 'Initialize-LELEReportConfigurationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportConfigurationUpdate -Name "TEST_VALUE" -Description "TEST_VALUE" -IsEnabled "TEST_VALUE" -Notification "TEST_VALUE"
            #$NewObject | Should -BeOfType ReportConfigurationUpdate
