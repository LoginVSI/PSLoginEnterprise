...
Describe -tag 'PSLoginEnterprise' -name 'LEReportConfigurationSortKey' {
    Context 'LEReportConfigurationSortKey' {
        It 'Initialize-LELEReportConfigurationSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportConfigurationSortKey
            #$NewObject | Should -BeOfType ReportConfigurationSortKey
