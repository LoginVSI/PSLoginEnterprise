...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationGetLauncherGroup200Response' {
    Context 'LEConfigurationGetLauncherGroup200Response' {
        It 'Initialize-LELEConfigurationGetLauncherGroup200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationGetLauncherGroup200Response -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Members "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -VarFilter "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationGetLauncherGroup200Response
