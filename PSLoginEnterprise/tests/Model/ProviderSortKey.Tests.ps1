...
Describe -tag 'PSLoginEnterprise' -name 'LEProviderSortKey' {
    Context 'LEProviderSortKey' {
        It 'Initialize-LELEProviderSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProviderSortKey
            #$NewObject | Should -BeOfType ProviderSortKey
