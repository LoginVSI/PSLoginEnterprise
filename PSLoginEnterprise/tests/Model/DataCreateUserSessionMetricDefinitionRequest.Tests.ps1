...
Describe -tag 'PSLoginEnterprise' -name 'LEDataCreateUserSessionMetricDefinitionRequest' {
    Context 'LEDataCreateUserSessionMetricDefinitionRequest' {
        It 'Initialize-LELEDataCreateUserSessionMetricDefinitionRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDataCreateUserSessionMetricDefinitionRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE" -Measurement "TEST_VALUE" -WmiQuery "TEST_VALUE" -Namespace "TEST_VALUE" -InstanceField "TEST_VALUE" -Measurements "TEST_VALUE"
            #$NewObject | Should -BeOfType DataCreateUserSessionMetricDefinitionRequest
