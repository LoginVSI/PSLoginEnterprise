...
Describe -tag 'PSLoginEnterprise' -name 'LEWorkloadSnapshot' {
    Context 'LEWorkloadSnapshot' {
        It 'Initialize-LELEWorkloadSnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWorkloadSnapshot -Steps "TEST_VALUE"
            #$NewObject | Should -BeOfType WorkloadSnapshot
