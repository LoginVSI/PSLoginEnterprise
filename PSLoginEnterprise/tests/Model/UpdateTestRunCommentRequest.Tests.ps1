...
Describe -tag 'PSLoginEnterprise' -name 'UpdateTestRunCommentRequest' {
    Context 'UpdateTestRunCommentRequest' {
        It 'Initialize-UpdateTestRunCommentRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-UpdateTestRunCommentRequest -Comment "TEST_VALUE"
            #$NewObject | Should -BeOfType UpdateTestRunCommentRequest
