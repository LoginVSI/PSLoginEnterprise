...
Describe -tag 'PSLoginEnterprise' -name 'LETestReference' {
    Context 'LETestReference' {
        It 'Initialize-LELETestReference' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestReference -TestId "TEST_VALUE" -TestType "TEST_VALUE"
            #$NewObject | Should -BeOfType TestReference
