...
Describe -tag 'PSLoginEnterprise' -name 'LELoadTestRunStatistics' {
    Context 'LELoadTestRunStatistics' {
        It 'Initialize-LELELoadTestRunStatistics' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELoadTestRunStatistics -EuxScores "TEST_VALUE" -BaseTimestamp "TEST_VALUE" -VsiMaxOffset "TEST_VALUE"
            #$NewObject | Should -BeOfType LoadTestRunStatistics
