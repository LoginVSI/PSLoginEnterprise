...
Describe -tag 'PSLoginEnterprise' -name 'LETestAccessBulkUpdate' {
    Context 'LETestAccessBulkUpdate' {
        It 'Initialize-LELETestAccessBulkUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestAccessBulkUpdate -TestIds "TEST_VALUE" -RoleIds "TEST_VALUE"
            #$NewObject | Should -BeOfType TestAccessBulkUpdate
