...
Describe -tag 'PSLoginEnterprise' -name 'LEAffected' {
    Context 'LEAffected' {
        It 'Initialize-LELEAffected' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAffected -Count "TEST_VALUE"
            #$NewObject | Should -BeOfType Affected
