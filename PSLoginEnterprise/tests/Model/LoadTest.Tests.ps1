...
Describe -tag 'PSLoginEnterprise' -name 'LELoadTest' {
    Context 'LELoadTest' {
        It 'Initialize-LELELoadTest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELoadTest -Type "TEST_VALUE" -Id "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -ConnectionResources "TEST_VALUE" -Workload "TEST_VALUE" -LogonTimeTrackingProcess "TEST_VALUE" -EngineStartTimeout "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -RampUpDurationInMinutes "TEST_VALUE" -TestDurationInMinutes "TEST_VALUE" -RampDownDurationInMinutes "TEST_VALUE" -State "TEST_VALUE" -EuxEnabled "TEST_VALUE" -EuxWorkFolders "TEST_VALUE" -SessionMetricsEnabled "TEST_VALUE" -SessionMetricScheduleRate "TEST_VALUE" -SessionMetricGroupKey "TEST_VALUE"
            #$NewObject | Should -BeOfType LoadTest
