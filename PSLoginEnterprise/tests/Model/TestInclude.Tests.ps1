...
Describe -tag 'PSLoginEnterprise' -name 'LETestInclude' {
    Context 'LETestInclude' {
        It 'Initialize-LELETestInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestInclude
            #$NewObject | Should -BeOfType TestInclude
