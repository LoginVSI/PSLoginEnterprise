...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherGroupResultSet' {
    Context 'LELauncherGroupResultSet' {
        It 'Initialize-LELELauncherGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherGroupResultSet
