...
Describe -tag 'PSLoginEnterprise' -name 'LEAddPlatformMetricsStatus' {
    Context 'LEAddPlatformMetricsStatus' {
        It 'Initialize-LELEAddPlatformMetricsStatus' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAddPlatformMetricsStatus
            #$NewObject | Should -BeOfType AddPlatformMetricsStatus
