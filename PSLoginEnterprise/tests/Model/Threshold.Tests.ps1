...
Describe -tag 'PSLoginEnterprise' -name 'LEThreshold' {
    Context 'LEThreshold' {
        It 'Initialize-LELEThreshold' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEThreshold -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE"
            #$NewObject | Should -BeOfType Threshold
