...
Describe -tag 'PSLoginEnterprise' -name 'LEDelaySnapshot' {
    Context 'LEDelaySnapshot' {
        It 'Initialize-LELEDelaySnapshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEDelaySnapshot -Type "TEST_VALUE" -DelayInSeconds "TEST_VALUE"
            #$NewObject | Should -BeOfType DelaySnapshot
