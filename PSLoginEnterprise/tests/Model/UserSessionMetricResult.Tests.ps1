...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricResult' {
    Context 'LEUserSessionMetricResult' {
        It 'Initialize-LELEUserSessionMetricResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricResult -Timestamp "TEST_VALUE" -TestRunId "TEST_VALUE" -UserSessionKey "TEST_VALUE" -Measurement "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE" -Instance "TEST_VALUE" -Tag "TEST_VALUE" -FieldName "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionMetricResult
