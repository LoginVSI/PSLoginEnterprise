...
Describe -tag 'PSLoginEnterprise' -name 'LEProvider' {
    Context 'LEProvider' {
        It 'Initialize-LELEProvider' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEProvider -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Environments "TEST_VALUE"
