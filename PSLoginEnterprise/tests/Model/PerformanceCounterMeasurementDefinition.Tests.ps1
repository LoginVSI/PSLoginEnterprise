...
Describe -tag 'PSLoginEnterprise' -name 'LEPerformanceCounterMeasurementDefinition' {
    Context 'LEPerformanceCounterMeasurementDefinition' {
        It 'Initialize-LELEPerformanceCounterMeasurementDefinition' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPerformanceCounterMeasurementDefinition -CounterCategory "TEST_VALUE" -CounterName "TEST_VALUE" -CounterInstance "TEST_VALUE" -MetricId "TEST_VALUE" -Key "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE"
            #$NewObject | Should -BeOfType PerformanceCounterMeasurementDefinition
