...
Describe -tag 'PSLoginEnterprise' -name 'LETestResultSet' {
    Context 'LETestResultSet' {
        It 'Initialize-LELETestResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType TestResultSet
