...
Describe -tag 'PSLoginEnterprise' -name 'LEAppInvocationUpdate' {
    Context 'LEAppInvocationUpdate' {
        It 'Initialize-LELEAppInvocationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppInvocationUpdate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE"
            #$NewObject | Should -BeOfType AppInvocationUpdate
