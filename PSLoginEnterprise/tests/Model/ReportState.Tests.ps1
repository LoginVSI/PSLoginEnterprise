...
Describe -tag 'PSLoginEnterprise' -name 'LEReportState' {
    Context 'LEReportState' {
        It 'Initialize-LELEReportState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportState
            #$NewObject | Should -BeOfType ReportState
