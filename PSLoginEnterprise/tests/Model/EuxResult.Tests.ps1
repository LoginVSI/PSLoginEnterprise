...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxResult' {
    Context 'LEEuxResult' {
        It 'Initialize-LELEEuxResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxResult -Timestamp "TEST_VALUE" -Score "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxResult
