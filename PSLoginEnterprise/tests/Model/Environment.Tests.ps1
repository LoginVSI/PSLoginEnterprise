...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironment' {
    Context 'LEEnvironment' {
        It 'Initialize-LELEEnvironment' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironment -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -EnableEnvironmentDataCollection "TEST_VALUE" -EnableCostCalculation "TEST_VALUE" -EnvironmentCost "TEST_VALUE" -EnvironmentAttributes "TEST_VALUE" -Provider "TEST_VALUE" -Tests "TEST_VALUE"
