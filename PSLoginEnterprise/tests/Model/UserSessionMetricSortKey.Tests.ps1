...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricSortKey' {
    Context 'LEUserSessionMetricSortKey' {
        It 'Initialize-LELEUserSessionMetricSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricSortKey
            #$NewObject | Should -BeOfType UserSessionMetricSortKey
