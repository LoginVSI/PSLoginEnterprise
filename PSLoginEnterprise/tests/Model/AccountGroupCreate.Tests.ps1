...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountGroupCreate' {
    Context 'LEAccountGroupCreate' {
        It 'Initialize-LELEAccountGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountGroupCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountGroupCreate
