...
Describe -tag 'PSLoginEnterprise' -name 'LELdapGroupSortKey' {
    Context 'LELdapGroupSortKey' {
        It 'Initialize-LELELdapGroupSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELdapGroupSortKey
            #$NewObject | Should -BeOfType LdapGroupSortKey
