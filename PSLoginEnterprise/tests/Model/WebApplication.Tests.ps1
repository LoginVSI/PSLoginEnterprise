...
Describe -tag 'PSLoginEnterprise' -name 'LEWebApplication' {
    Context 'LEWebApplication' {
        It 'Initialize-LELEWebApplication' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebApplication -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Script "TEST_VALUE" -Timers "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -HasPassword "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE"
            #$NewObject | Should -BeOfType WebApplication
