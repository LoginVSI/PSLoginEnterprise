...
Describe -tag 'PSLoginEnterprise' -name 'LETestProviderConnectionResult' {
    Context 'LETestProviderConnectionResult' {
        It 'Initialize-LELETestProviderConnectionResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestProviderConnectionResult -Success "TEST_VALUE" -StatusMessage "TEST_VALUE"
            #$NewObject | Should -BeOfType TestProviderConnectionResult
