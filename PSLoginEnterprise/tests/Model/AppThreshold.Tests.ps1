...
Describe -tag 'PSLoginEnterprise' -name 'LEAppThreshold' {
    Context 'LEAppThreshold' {
        It 'Initialize-LELEAppThreshold' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppThreshold -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -ApplicationId "TEST_VALUE" -ApplicationName "TEST_VALUE" -Timer "TEST_VALUE"
            #$NewObject | Should -BeOfType AppThreshold
