...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherGroupData' {
    Context 'LELauncherGroupData' {
        It 'Initialize-LELELauncherGroupData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherGroupData -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherGroupData
