...
Describe -tag 'PSLoginEnterprise' -name 'LETestAzureConnectionData' {
    Context 'LETestAzureConnectionData' {
        It 'Initialize-LELETestAzureConnectionData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestAzureConnectionData -Type "TEST_VALUE" -ProviderId "TEST_VALUE" -TenantId "TEST_VALUE" -ApplicationId "TEST_VALUE" -Secret "TEST_VALUE"
            #$NewObject | Should -BeOfType TestAzureConnectionData
