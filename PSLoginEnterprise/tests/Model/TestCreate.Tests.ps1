...
Describe -tag 'PSLoginEnterprise' -name 'LETestCreate' {
    Context 'LETestCreate' {
        It 'Initialize-LELETestCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Connector "TEST_VALUE" -AccountGroups "TEST_VALUE" -LauncherGroups "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -ApplicationDebugModeEnabled "TEST_VALUE" -Roles "TEST_VALUE"
            #$NewObject | Should -BeOfType TestCreate
