...
Describe -tag 'PSLoginEnterprise' -name 'LEPlatformSummary' {
    Context 'LEPlatformSummary' {
        It 'Initialize-LELEPlatformSummary' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPlatformSummary -LoginSuccessful "TEST_VALUE" -LoginPerformance "TEST_VALUE" -LatencyPerformance "TEST_VALUE"
            #$NewObject | Should -BeOfType PlatformSummary
