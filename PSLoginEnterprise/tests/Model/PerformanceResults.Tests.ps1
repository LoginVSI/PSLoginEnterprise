...
Describe -tag 'PSLoginEnterprise' -name 'LEPerformanceResults' {
    Context 'LEPerformanceResults' {
        It 'Initialize-LELEPerformanceResults' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPerformanceResults -EuxState "TEST_VALUE" -VsiMaxState "TEST_VALUE" -Results "TEST_VALUE"
            #$NewObject | Should -BeOfType PerformanceResults
