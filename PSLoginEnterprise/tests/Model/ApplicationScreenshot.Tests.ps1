...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationScreenshot' {
    Context 'LEApplicationScreenshot' {
        It 'Initialize-LELEApplicationScreenshot' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationScreenshot -Title "TEST_VALUE" -Uri "TEST_VALUE" -Type "TEST_VALUE" -Description "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationScreenshot
