...
Describe -tag 'PSLoginEnterprise' -name 'LEBrowserName' {
    Context 'LEBrowserName' {
        It 'Initialize-LELEBrowserName' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEBrowserName
            #$NewObject | Should -BeOfType BrowserName
