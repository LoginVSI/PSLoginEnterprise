...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationUpdateStepInApplicationGroupRequest' {
    Context 'LEConfigurationUpdateStepInApplicationGroupRequest' {
        It 'Initialize-LELEConfigurationUpdateStepInApplicationGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationUpdateStepInApplicationGroupRequest -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -DelayInSeconds "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationUpdateStepInApplicationGroupRequest
