...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationCreateApplicationRequest' {
    Context 'LEConfigurationCreateApplicationRequest' {
        It 'Initialize-LELEConfigurationCreateApplicationRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationCreateApplicationRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE" -Roles "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -ProfileLocation "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationCreateApplicationRequest
