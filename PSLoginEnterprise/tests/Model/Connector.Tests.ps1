...
Describe -tag 'PSLoginEnterprise' -name 'LEConnector' {
    Context 'LEConnector' {
        It 'Initialize-LELEConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConnector -Type "TEST_VALUE"
            #$NewObject | Should -BeOfType Connector
