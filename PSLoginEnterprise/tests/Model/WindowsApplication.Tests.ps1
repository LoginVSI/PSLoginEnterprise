...
Describe -tag 'PSLoginEnterprise' -name 'LEWindowsApplication' {
    Context 'LEWindowsApplication' {
        It 'Initialize-LELEWindowsApplication' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWindowsApplication -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Script "TEST_VALUE" -Timers "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -HasPassword "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE" -MainWindowTitle "TEST_VALUE" -MainProcessName "TEST_VALUE"
            #$NewObject | Should -BeOfType WindowsApplication
