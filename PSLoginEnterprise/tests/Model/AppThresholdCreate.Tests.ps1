...
Describe -tag 'PSLoginEnterprise' -name 'LEAppThresholdCreate' {
    Context 'LEAppThresholdCreate' {
        It 'Initialize-LELEAppThresholdCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppThresholdCreate -ApplicationId "TEST_VALUE" -Timer "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE"
            #$NewObject | Should -BeOfType AppThresholdCreate
