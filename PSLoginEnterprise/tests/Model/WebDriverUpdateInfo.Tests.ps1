...
Describe -tag 'PSLoginEnterprise' -name 'LEWebDriverUpdateInfo' {
    Context 'LEWebDriverUpdateInfo' {
        It 'Initialize-LELEWebDriverUpdateInfo' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWebDriverUpdateInfo -AutoUpdateEnabled "TEST_VALUE" -LastUpdateTime "TEST_VALUE" -UpdateState "TEST_VALUE"
            #$NewObject | Should -BeOfType WebDriverUpdateInfo
