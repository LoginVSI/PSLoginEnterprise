...
Describe -tag 'PSLoginEnterprise' -name 'LEContinuousTestRun' {
    Context 'LEContinuousTestRun' {
        It 'Initialize-LELEContinuousTestRun' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEContinuousTestRun -Type "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -Created "TEST_VALUE" -Started "TEST_VALUE" -Finished "TEST_VALUE" -Counter "TEST_VALUE" -NumberOfEvents "TEST_VALUE" -TestName "TEST_VALUE" -SessionMetricGroupKey "TEST_VALUE" -EnvironmentKey "TEST_VALUE" -ScheduleType "TEST_VALUE" -Description "TEST_VALUE" -ConnectorId "TEST_VALUE"
            #$NewObject | Should -BeOfType ContinuousTestRun
