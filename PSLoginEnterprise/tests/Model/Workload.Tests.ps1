...
Describe -tag 'PSLoginEnterprise' -name 'LEWorkload' {
    Context 'LEWorkload' {
        It 'Initialize-LELEWorkload' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWorkload -Steps "TEST_VALUE"
            #$NewObject | Should -BeOfType Workload
