...
Describe -tag 'PSLoginEnterprise' -name 'LEObjectId' {
    Context 'LEObjectId' {
        It 'Initialize-LELEObjectId' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEObjectId -Id "TEST_VALUE"
            #$NewObject | Should -BeOfType ObjectId
