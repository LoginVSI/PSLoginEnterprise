...
Describe -tag 'PSLoginEnterprise' -name 'LEStep' {
    Context 'LEStep' {
        It 'Initialize-LELEStep' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEStep -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE"
            #$NewObject | Should -BeOfType Step
