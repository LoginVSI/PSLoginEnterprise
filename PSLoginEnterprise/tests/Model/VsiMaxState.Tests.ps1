...
Describe -tag 'PSLoginEnterprise' -name 'LEVsiMaxState' {
    Context 'LEVsiMaxState' {
        It 'Initialize-LELEVsiMaxState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEVsiMaxState
            #$NewObject | Should -BeOfType VsiMaxState
