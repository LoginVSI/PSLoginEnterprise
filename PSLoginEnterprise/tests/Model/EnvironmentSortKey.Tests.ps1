...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironmentSortKey' {
    Context 'LEEnvironmentSortKey' {
        It 'Initialize-LELEEnvironmentSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironmentSortKey
            #$NewObject | Should -BeOfType EnvironmentSortKey
