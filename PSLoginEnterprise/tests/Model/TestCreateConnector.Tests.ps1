...
Describe -tag 'PSLoginEnterprise' -name 'LETestCreateConnector' {
    Context 'LETestCreateConnector' {
        It 'Initialize-LELETestCreateConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestCreateConnector -Type "TEST_VALUE" -VarHost "TEST_VALUE" -CommandLine "TEST_VALUE" -Resource "TEST_VALUE" -ServerUrl "TEST_VALUE" -DisplayResolution "TEST_VALUE" -SeamlessMode "TEST_VALUE" -HostList "TEST_VALUE" -Gateway "TEST_VALUE" -SuppressCertWarn "TEST_VALUE"
            #$NewObject | Should -BeOfType TestCreateConnector
