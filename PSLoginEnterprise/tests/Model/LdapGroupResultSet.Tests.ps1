...
Describe -tag 'PSLoginEnterprise' -name 'LELdapGroupResultSet' {
    Context 'LELdapGroupResultSet' {
        It 'Initialize-LELELdapGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELdapGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType LdapGroupResultSet
