...
Describe -tag 'PSLoginEnterprise' -name 'LELoginState' {
    Context 'LELoginState' {
        It 'Initialize-LELELoginState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELoginState
            #$NewObject | Should -BeOfType LoginState
