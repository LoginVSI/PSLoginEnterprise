...
Describe -tag 'PSLoginEnterprise' -name 'LENotification' {
    Context 'LENotification' {
        It 'Initialize-LELENotification' {
            # a simple test to create an object
            #$NewObject = Initialize-LELENotification -Type "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE"
