...
Describe -tag 'PSLoginEnterprise' -name 'LEUpdateFromProviderResult' {
    Context 'LEUpdateFromProviderResult' {
        It 'Initialize-LELEUpdateFromProviderResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUpdateFromProviderResult -Successful "TEST_VALUE" -WarningMessage "TEST_VALUE"
            #$NewObject | Should -BeOfType UpdateFromProviderResult
