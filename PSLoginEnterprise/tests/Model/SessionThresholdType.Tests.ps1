...
Describe -tag 'PSLoginEnterprise' -name 'LESessionThresholdType' {
    Context 'LESessionThresholdType' {
        It 'Initialize-LELESessionThresholdType' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionThresholdType
            #$NewObject | Should -BeOfType SessionThresholdType
