...
Describe -tag 'PSLoginEnterprise' -name 'LEWindowsApplicationCreate' {
    Context 'LEWindowsApplicationCreate' {
        It 'Initialize-LELEWindowsApplicationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWindowsApplicationCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -TakeScreenshots "TEST_VALUE" -ScriptContent "TEST_VALUE" -Roles "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
            #$NewObject | Should -BeOfType WindowsApplicationCreate
