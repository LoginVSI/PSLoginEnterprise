...
Describe -tag 'PSLoginEnterprise' -name 'LEPerformanceCounterMeasurementDefinitionCreate' {
    Context 'LEPerformanceCounterMeasurementDefinitionCreate' {
        It 'Initialize-LELEPerformanceCounterMeasurementDefinitionCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEPerformanceCounterMeasurementDefinitionCreate -CounterCategory "TEST_VALUE" -CounterName "TEST_VALUE" -CounterInstance "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE"
            #$NewObject | Should -BeOfType PerformanceCounterMeasurementDefinitionCreate
