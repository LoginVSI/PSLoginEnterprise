...
Describe -tag 'PSLoginEnterprise' -name 'LEAppExecution' {
    Context 'LEAppExecution' {
        It 'Initialize-LELEAppExecution' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppExecution -TestRunId "TEST_VALUE" -Id "TEST_VALUE" -UserSessionId "TEST_VALUE" -ApplicationId "TEST_VALUE" -State "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
