...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationInclude' {
    Context 'LEApplicationInclude' {
        It 'Initialize-LELEApplicationInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationInclude
            #$NewObject | Should -BeOfType ApplicationInclude
