...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTestData' {
    Context 'LEApplicationTestData' {
        It 'Initialize-LELEApplicationTestData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTestData -TestRunId "TEST_VALUE" -TestName "TEST_VALUE" -IsBase "TEST_VALUE" -Counter "TEST_VALUE" -State "TEST_VALUE" -TestResult "TEST_VALUE" -PlatformSummary "TEST_VALUE" -ApplicationSummaries "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTestData
