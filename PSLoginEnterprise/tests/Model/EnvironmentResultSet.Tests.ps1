...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironmentResultSet' {
    Context 'LEEnvironmentResultSet' {
        It 'Initialize-LELEEnvironmentResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironmentResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType EnvironmentResultSet
