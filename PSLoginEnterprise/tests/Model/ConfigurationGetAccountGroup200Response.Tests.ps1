...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationGetAccountGroup200Response' {
    Context 'LEConfigurationGetAccountGroup200Response' {
        It 'Initialize-LELEConfigurationGetAccountGroup200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationGetAccountGroup200Response -Type "TEST_VALUE" -GroupId "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Members "TEST_VALUE" -VarFilter "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationGetAccountGroup200Response
