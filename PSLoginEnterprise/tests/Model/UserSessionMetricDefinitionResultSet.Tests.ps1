...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricDefinitionResultSet' {
    Context 'LEUserSessionMetricDefinitionResultSet' {
        It 'Initialize-LELEUserSessionMetricDefinitionResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricDefinitionResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionMetricDefinitionResultSet
