...
Describe -tag 'PSLoginEnterprise' -name 'LEReportConfigurationCreate' {
    Context 'LEReportConfigurationCreate' {
        It 'Initialize-LELEReportConfigurationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEReportConfigurationCreate -Frequency "TEST_VALUE" -LatencyThreshold "TEST_VALUE" -LoginTimeThreshold "TEST_VALUE" -TimeZoneOffset "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -IsEnabled "TEST_VALUE" -Notification "TEST_VALUE"
            #$NewObject | Should -BeOfType ReportConfigurationCreate
