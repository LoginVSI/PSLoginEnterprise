...
Describe -tag 'PSLoginEnterprise' -name 'LELocationResultSet' {
    Context 'LELocationResultSet' {
        It 'Initialize-LELELocationResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELocationResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
            #$NewObject | Should -BeOfType LocationResultSet
