...
Describe -tag 'PSLoginEnterprise' -name 'LETestProviderConnectionData' {
    Context 'LETestProviderConnectionData' {
        It 'Initialize-LELETestProviderConnectionData' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestProviderConnectionData -Type "TEST_VALUE" -ProviderId "TEST_VALUE"
            #$NewObject | Should -BeOfType TestProviderConnectionData
