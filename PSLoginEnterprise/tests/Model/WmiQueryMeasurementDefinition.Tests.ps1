...
Describe -tag 'PSLoginEnterprise' -name 'LEWmiQueryMeasurementDefinition' {
    Context 'LEWmiQueryMeasurementDefinition' {
        It 'Initialize-LELEWmiQueryMeasurementDefinition' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEWmiQueryMeasurementDefinition -PropertyName "TEST_VALUE" -SummarizeOperation "TEST_VALUE" -MetricId "TEST_VALUE" -Key "TEST_VALUE" -DisplayName "TEST_VALUE" -Unit "TEST_VALUE"
            #$NewObject | Should -BeOfType WmiQueryMeasurementDefinition
