...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountSelectionGroup' {
    Context 'LEAccountSelectionGroup' {
        It 'Initialize-LELEAccountSelectionGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountSelectionGroup -Type "TEST_VALUE" -GroupId "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Members "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountSelectionGroup
