...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationSortKey' {
    Context 'LEApplicationSortKey' {
        It 'Initialize-LELEApplicationSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationSortKey
            #$NewObject | Should -BeOfType ApplicationSortKey
