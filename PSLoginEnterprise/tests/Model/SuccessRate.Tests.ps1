...
Describe -tag 'PSLoginEnterprise' -name 'LESuccessRate' {
    Context 'LESuccessRate' {
        It 'Initialize-LELESuccessRate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESuccessRate -Failed "TEST_VALUE" -Total "TEST_VALUE" -Percentage "TEST_VALUE"
            #$NewObject | Should -BeOfType SuccessRate
