...
Describe -tag 'PSLoginEnterprise' -name 'LENetscalerConnector' {
    Context 'LENetscalerConnector' {
        It 'Initialize-LELENetscalerConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-LELENetscalerConnector -Type "TEST_VALUE" -ServerUrl "TEST_VALUE" -Resource "TEST_VALUE" -DisplayResolution "TEST_VALUE" -SeamlessMode "TEST_VALUE"
            #$NewObject | Should -BeOfType NetscalerConnector
