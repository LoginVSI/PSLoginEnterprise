...
Describe -tag 'PSLoginEnterprise' -name 'LELauncherFilterGroup' {
    Context 'LELauncherFilterGroup' {
        It 'Initialize-LELELauncherFilterGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELauncherFilterGroup -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Members "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -VarFilter "TEST_VALUE"
            #$NewObject | Should -BeOfType LauncherFilterGroup
