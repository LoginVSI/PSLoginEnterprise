...
Describe -tag 'PSLoginEnterprise' -name 'LESessionMetricDefinitionSortKey' {
    Context 'LESessionMetricDefinitionSortKey' {
        It 'Initialize-LELESessionMetricDefinitionSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionMetricDefinitionSortKey
            #$NewObject | Should -BeOfType SessionMetricDefinitionSortKey
