...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationTimerResult' {
    Context 'LEApplicationTimerResult' {
        It 'Initialize-LELEApplicationTimerResult' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationTimerResult -Timer "TEST_VALUE" -PerformanceResult "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationTimerResult
