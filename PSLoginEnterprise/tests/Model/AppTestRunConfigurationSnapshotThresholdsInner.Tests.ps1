...
Describe -tag 'PSLoginEnterprise' -name 'LEAppTestRunConfigurationSnapshotThresholdsInner' {
    Context 'LEAppTestRunConfigurationSnapshotThresholdsInner' {
        It 'Initialize-LELEAppTestRunConfigurationSnapshotThresholdsInner' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAppTestRunConfigurationSnapshotThresholdsInner -Type "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -ApplicationName "TEST_VALUE" -Timer "TEST_VALUE" -Target "TEST_VALUE"
            #$NewObject | Should -BeOfType AppTestRunConfigurationSnapshotThresholdsInner
