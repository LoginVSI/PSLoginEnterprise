...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationGetApplicationTestThresholds200ResponseInner' {
    Context 'LEConfigurationGetApplicationTestThresholds200ResponseInner' {
        It 'Initialize-LELEConfigurationGetApplicationTestThresholds200ResponseInner' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationGetApplicationTestThresholds200ResponseInner -Type "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -ApplicationId "TEST_VALUE" -ApplicationName "TEST_VALUE" -Timer "TEST_VALUE" -Target "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationGetApplicationTestThresholds200ResponseInner
