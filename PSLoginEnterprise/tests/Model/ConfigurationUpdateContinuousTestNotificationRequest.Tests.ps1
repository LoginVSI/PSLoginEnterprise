...
Describe -tag 'PSLoginEnterprise' -name 'LEConfigurationUpdateContinuousTestNotificationRequest' {
    Context 'LEConfigurationUpdateContinuousTestNotificationRequest' {
        It 'Initialize-LELEConfigurationUpdateContinuousTestNotificationRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEConfigurationUpdateContinuousTestNotificationRequest -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE" -ThresholdUpdate "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationUpdateContinuousTestNotificationRequest
