...
Describe -tag 'PSLoginEnterprise' -name 'LELdapGroupUpdate' {
    Context 'LELdapGroupUpdate' {
        It 'Initialize-LELELdapGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELELdapGroupUpdate -DisplayName "TEST_VALUE" -GroupIdentity "TEST_VALUE" -RoleIds "TEST_VALUE"
            #$NewObject | Should -BeOfType LdapGroupUpdate
