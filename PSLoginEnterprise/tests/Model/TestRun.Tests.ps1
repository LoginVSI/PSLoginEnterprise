...
Describe -tag 'PSLoginEnterprise' -name 'LETestRun' {
    Context 'LETestRun' {
        It 'Initialize-LELETestRun' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETestRun -Type "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -Created "TEST_VALUE" -Started "TEST_VALUE" -Finished "TEST_VALUE" -Counter "TEST_VALUE" -NumberOfEvents "TEST_VALUE"
            #$NewObject | Should -BeOfType TestRun
