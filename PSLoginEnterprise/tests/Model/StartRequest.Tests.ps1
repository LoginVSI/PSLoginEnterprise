...
Describe -tag 'PSLoginEnterprise' -name 'LEStartRequest' {
    Context 'LEStartRequest' {
        It 'Initialize-LELEStartRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEStartRequest -Comment "TEST_VALUE"
            #$NewObject | Should -BeOfType StartRequest
