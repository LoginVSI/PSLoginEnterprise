...
Describe -tag 'PSLoginEnterprise' -name 'LEApplicationGroupCreate' {
    Context 'LEApplicationGroupCreate' {
        It 'Initialize-LELEApplicationGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEApplicationGroupCreate -Name "TEST_VALUE" -Description "TEST_VALUE" -Steps "TEST_VALUE" -Roles "TEST_VALUE"
            #$NewObject | Should -BeOfType ApplicationGroupCreate
