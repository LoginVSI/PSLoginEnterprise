...
Describe -tag 'PSLoginEnterprise' -name 'LEAccountSelectionGroupCreate' {
    Context 'LEAccountSelectionGroupCreate' {
        It 'Initialize-LELEAccountSelectionGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEAccountSelectionGroupCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -MemberIds "TEST_VALUE"
            #$NewObject | Should -BeOfType AccountSelectionGroupCreate
