...
Describe -tag 'PSLoginEnterprise' -name 'LESessionState' {
    Context 'LESessionState' {
        It 'Initialize-LELESessionState' {
            # a simple test to create an object
            #$NewObject = Initialize-LELESessionState
            #$NewObject | Should -BeOfType SessionState
