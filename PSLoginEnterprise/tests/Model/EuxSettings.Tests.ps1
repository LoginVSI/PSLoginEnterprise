...
Describe -tag 'PSLoginEnterprise' -name 'LEEuxSettings' {
    Context 'LEEuxSettings' {
        It 'Initialize-LELEEuxSettings' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEuxSettings -EnableEuxRawDataSave "TEST_VALUE"
            #$NewObject | Should -BeOfType EuxSettings
