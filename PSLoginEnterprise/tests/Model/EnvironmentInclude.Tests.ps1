...
Describe -tag 'PSLoginEnterprise' -name 'LEEnvironmentInclude' {
    Context 'LEEnvironmentInclude' {
        It 'Initialize-LELEEnvironmentInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEEnvironmentInclude
            #$NewObject | Should -BeOfType EnvironmentInclude
