...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSessionMetricDefinitionCreate' {
    Context 'LEUserSessionMetricDefinitionCreate' {
        It 'Initialize-LELEUserSessionMetricDefinitionCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSessionMetricDefinitionCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Tag "TEST_VALUE"
            #$NewObject | Should -BeOfType UserSessionMetricDefinitionCreate
