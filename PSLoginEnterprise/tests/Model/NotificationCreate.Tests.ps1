...
Describe -tag 'PSLoginEnterprise' -name 'LENotificationCreate' {
    Context 'LENotificationCreate' {
        It 'Initialize-LELENotificationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LELENotificationCreate -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -EmailRecipients "TEST_VALUE" -UseCustomMailRecipient "TEST_VALUE"
            #$NewObject | Should -BeOfType NotificationCreate
