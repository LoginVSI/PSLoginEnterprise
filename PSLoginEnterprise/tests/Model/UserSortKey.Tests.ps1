...
Describe -tag 'PSLoginEnterprise' -name 'LEUserSortKey' {
    Context 'LEUserSortKey' {
        It 'Initialize-LELEUserSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LELEUserSortKey
            #$NewObject | Should -BeOfType UserSortKey
