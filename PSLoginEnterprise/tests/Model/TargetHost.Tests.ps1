...
Describe -tag 'PSLoginEnterprise' -name 'LETargetHost' {
    Context 'LETargetHost' {
        It 'Initialize-LELETargetHost' {
            # a simple test to create an object
            #$NewObject = Initialize-LELETargetHost -Enabled "TEST_VALUE" -Endpoint "TEST_VALUE"
            #$NewObject | Should -BeOfType TargetHost
