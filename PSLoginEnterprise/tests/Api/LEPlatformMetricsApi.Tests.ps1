...
Describe -tag 'PSLoginEnterprise' -name 'LELEPlatformMetricsApi' {
    Context 'Add-LEPlatformMetrics' {
        It 'Test Add-LEPlatformMetrics' {
            #$TestResult = Add-LEPlatformMetrics -PlatformMetric "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEPlatformMetrics' {
        It 'Test Get-LEPlatformMetrics' {
            #$TestResult = Get-LEPlatformMetrics -From "TEST_VALUE" -To "TEST_VALUE" -EnvironmentIds "TEST_VALUE" -MetricIds "TEST_VALUE" -MetricGroups "TEST_VALUE" -Instances "TEST_VALUE" -ComponentTypes "TEST_VALUE" -AggregationWindowEvery "TEST_VALUE" -AggregationWindowFn "TEST_VALUE" -GroupColumns "TEST_VALUE" -CustomTagsFilters "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
