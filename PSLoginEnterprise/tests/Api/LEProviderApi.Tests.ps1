...
Describe -tag 'PSLoginEnterprise' -name 'LELEProviderApi' {
    Context 'New-LEProvider' {
        It 'Test New-LEProvider' {
            #$TestResult = New-LEProvider -ProviderAzureData "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-LEDeleteProvider' {
        It 'Test Invoke-LEDeleteProvider' {
            #$TestResult = Invoke-LEDeleteProvider -ProviderId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEProviderById' {
        It 'Test Get-LEProviderById' {
            #$TestResult = Get-LEProviderById -ProviderId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEProviders' {
        It 'Test Get-LEProviders' {
            #$TestResult = Get-LEProviders -OrderBy "TEST_VALUE" -Direction "TEST_VALUE" -Count "TEST_VALUE" -Filter "TEST_VALUE" -Offset "TEST_VALUE" -IncludeTotalCount "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Test-LEProviderConnection' {
        It 'Test Test-LEProviderConnection' {
            #$TestResult = Test-LEProviderConnection -TestAzureConnectionData "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LEProvider' {
        It 'Test Update-LEProvider' {
            #$TestResult = Update-LEProvider -ProviderId "TEST_VALUE" -ProviderAzureData "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
