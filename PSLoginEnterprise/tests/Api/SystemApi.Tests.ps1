...
Describe -tag 'PSLoginEnterprise' -name 'SystemApi' {
    Context 'Invoke-DataGetSystemEuxVersion' {
        It 'Test Invoke-DataGetSystemEuxVersion' {
            #$TestResult = Invoke-DataGetSystemEuxVersion
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetSystemVersions' {
        It 'Test Invoke-DataGetSystemVersions' {
            #$TestResult = Invoke-DataGetSystemVersions
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
