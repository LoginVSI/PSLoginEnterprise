...
Describe -tag 'PSLoginEnterprise' -name 'EuxSettingsApi' {
    Context 'Invoke-ConfigurationGetEuxSettings' {
        It 'Test Invoke-ConfigurationGetEuxSettings' {
            #$TestResult = Invoke-ConfigurationGetEuxSettings
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationUpdateEuxSettings' {
        It 'Test Invoke-ConfigurationUpdateEuxSettings' {
            #$TestResult = Invoke-ConfigurationUpdateEuxSettings -EuxSettings "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
