...
Describe -tag 'PSLoginEnterprise' -name 'UserSessionApi' {
    Context 'Invoke-DataGetUserSession' {
        It 'Test Invoke-DataGetUserSession' {
            #$TestResult = Invoke-DataGetUserSession -TestRunId "TEST_VALUE" -UserSessionId "TEST_VALUE" -Include "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetUserSessions' {
        It 'Test Invoke-DataGetUserSessions' {
            #$TestResult = Invoke-DataGetUserSessions -TestRunId "TEST_VALUE" -Direction "TEST_VALUE" -Count "TEST_VALUE" -Offset "TEST_VALUE" -IncludeTotalCount "TEST_VALUE" -From "TEST_VALUE" -To "TEST_VALUE" -FilterType "TEST_VALUE" -Include "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
