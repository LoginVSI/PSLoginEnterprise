...
Describe -tag 'PSLoginEnterprise' -name 'ApplianceHealthApi' {
    Context 'Invoke-DataGetApplianceHealthAlertSettingsAsync' {
        It 'Test Invoke-DataGetApplianceHealthAlertSettingsAsync' {
            #$TestResult = Invoke-DataGetApplianceHealthAlertSettingsAsync
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetApplianceHealthMetricsAsync' {
        It 'Test Invoke-DataGetApplianceHealthMetricsAsync' {
            #$TestResult = Invoke-DataGetApplianceHealthMetricsAsync -From "TEST_VALUE" -To "TEST_VALUE" -MetricIds "TEST_VALUE" -AggregationWindowEvery "TEST_VALUE" -AggregationWindowFn "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataUpdateApplianceHealthAlertSettingsAsync' {
        It 'Test Invoke-DataUpdateApplianceHealthAlertSettingsAsync' {
            #$TestResult = Invoke-DataUpdateApplianceHealthAlertSettingsAsync -ApplianceHealthAlertSettings "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
