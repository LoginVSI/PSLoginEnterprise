...
Describe -tag 'PSLoginEnterprise' -name 'StatisticApi' {
    Context 'Invoke-DataGetApplicationDiagnostics' {
        It 'Test Invoke-DataGetApplicationDiagnostics' {
            #$TestResult = Invoke-DataGetApplicationDiagnostics -TestId "TEST_VALUE" -TimeRange "TEST_VALUE" -LocationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetContinuousTestDiagnostic' {
        It 'Test Invoke-DataGetContinuousTestDiagnostic' {
            #$TestResult = Invoke-DataGetContinuousTestDiagnostic -TestId "TEST_VALUE" -TimeRange "TEST_VALUE" -LocationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetContinuousTestDiagnostics' {
        It 'Test Invoke-DataGetContinuousTestDiagnostics' {
            #$TestResult = Invoke-DataGetContinuousTestDiagnostics -TimeRange "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
