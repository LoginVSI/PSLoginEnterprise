...
Describe -tag 'PSLoginEnterprise' -name 'LELELocationApi' {
    Context 'New-LELocation' {
        It 'Test New-LELocation' {
            #$TestResult = New-LELocation -LocationCreate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-LEDeleteLocation' {
        It 'Test Invoke-LEDeleteLocation' {
            #$TestResult = Invoke-LEDeleteLocation -LocationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-LEDeleteLocations' {
        It 'Test Invoke-LEDeleteLocations' {
            #$TestResult = Invoke-LEDeleteLocations -RequestBody "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LELocation' {
        It 'Test Get-LELocation' {
            #$TestResult = Get-LELocation -LocationId "TEST_VALUE" -Include "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LELocations' {
        It 'Test Get-LELocations' {
            #$TestResult = Get-LELocations -OrderBy "TEST_VALUE" -Direction "TEST_VALUE" -Count "TEST_VALUE" -Offset "TEST_VALUE" -IncludeTotalCount "TEST_VALUE" -Filter "TEST_VALUE" -Include "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LELocation' {
        It 'Test Update-LELocation' {
            #$TestResult = Update-LELocation -LocationId "TEST_VALUE" -LocationUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
