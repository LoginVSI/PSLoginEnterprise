...
Describe -tag 'PSLoginEnterprise' -name 'LELESystemApi' {
    Context 'Get-LESystemEuxVersion' {
        It 'Test Get-LESystemEuxVersion' {
            #$TestResult = Get-LESystemEuxVersion
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LESystemVersions' {
        It 'Test Get-LESystemVersions' {
            #$TestResult = Get-LESystemVersions
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
