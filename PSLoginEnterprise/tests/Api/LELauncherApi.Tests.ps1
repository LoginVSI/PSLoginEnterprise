...
Describe -tag 'PSLoginEnterprise' -name 'LELELauncherApi' {
    Context 'Get-LELauncher' {
        It 'Test Get-LELauncher' {
            #$TestResult = Get-LELauncher -LauncherName "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LELaunchers' {
        It 'Test Get-LELaunchers' {
            #$TestResult = Get-LELaunchers -OrderBy "TEST_VALUE" -Direction "TEST_VALUE" -Count "TEST_VALUE" -Filter "TEST_VALUE" -Offset "TEST_VALUE" -IncludeTotalCount "TEST_VALUE" -LocationIds "TEST_VALUE" -Online "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LELauncherLocation' {
        It 'Test Update-LELauncherLocation' {
            #$TestResult = Update-LELauncherLocation -LauncherName "TEST_VALUE" -LauncherLocationUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
