...
Describe -tag 'PSLoginEnterprise' -name 'ScriptApi' {
    Context 'Invoke-ConfigurationCreateScript' {
        It 'Test Invoke-ConfigurationCreateScript' {
            #$TestResult = Invoke-ConfigurationCreateScript -ApplicationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationGetScript' {
        It 'Test Invoke-ConfigurationGetScript' {
            #$TestResult = Invoke-ConfigurationGetScript -ApplicationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
