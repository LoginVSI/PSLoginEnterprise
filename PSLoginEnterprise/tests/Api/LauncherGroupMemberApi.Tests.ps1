...
Describe -tag 'PSLoginEnterprise' -name 'LauncherGroupMemberApi' {
    Context 'Invoke-ConfigurationAddLauncherGroupMembers' {
        It 'Test Invoke-ConfigurationAddLauncherGroupMembers' {
            #$TestResult = Invoke-ConfigurationAddLauncherGroupMembers -GroupId "TEST_VALUE" -RequestBody "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationGetLauncherGroupMembers' {
        It 'Test Invoke-ConfigurationGetLauncherGroupMembers' {
            #$TestResult = Invoke-ConfigurationGetLauncherGroupMembers -GroupId "TEST_VALUE" -OrderBy "TEST_VALUE" -Direction "TEST_VALUE" -Count "TEST_VALUE" -Offset "TEST_VALUE" -IncludeTotalCount "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationRemoveLauncherGroupMembers' {
        It 'Test Invoke-ConfigurationRemoveLauncherGroupMembers' {
            #$TestResult = Invoke-ConfigurationRemoveLauncherGroupMembers -GroupId "TEST_VALUE" -RequestBody "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
