...
Describe -tag 'PSLoginEnterprise' -name 'LELEPermissionApi' {
    Context 'Get-LEAllPermissions' {
        It 'Test Get-LEAllPermissions' {
            #$TestResult = Get-LEAllPermissions
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEPermissionsForCallingUser' {
        It 'Test Get-LEPermissionsForCallingUser' {
            #$TestResult = Get-LEPermissionsForCallingUser
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
