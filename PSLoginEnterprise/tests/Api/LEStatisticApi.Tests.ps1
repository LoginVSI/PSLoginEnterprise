...
Describe -tag 'PSLoginEnterprise' -name 'LELEStatisticApi' {
    Context 'Get-LEApplicationDiagnostics' {
        It 'Test Get-LEApplicationDiagnostics' {
            #$TestResult = Get-LEApplicationDiagnostics -TestId "TEST_VALUE" -TimeRange "TEST_VALUE" -LocationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEContinuousTestDiagnostic' {
        It 'Test Get-LEContinuousTestDiagnostic' {
            #$TestResult = Get-LEContinuousTestDiagnostic -TestId "TEST_VALUE" -TimeRange "TEST_VALUE" -LocationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEContinuousTestDiagnostics' {
        It 'Test Get-LEContinuousTestDiagnostics' {
            #$TestResult = Get-LEContinuousTestDiagnostics -TimeRange "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
