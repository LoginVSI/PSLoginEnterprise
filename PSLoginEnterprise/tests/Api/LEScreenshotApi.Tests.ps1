...
Describe -tag 'PSLoginEnterprise' -name 'LELEScreenshotApi' {
    Context 'Get-LEScreenshotByAppExecution' {
        It 'Test Get-LEScreenshotByAppExecution' {
            #$TestResult = Get-LEScreenshotByAppExecution -TestRunId "TEST_VALUE" -AppExecutionId "TEST_VALUE" -ScreenshotId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEScreenshotByEvent' {
        It 'Test Get-LEScreenshotByEvent' {
            #$TestResult = Get-LEScreenshotByEvent -TestRunId "TEST_VALUE" -EventId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEScreenshotsByAppExecution' {
        It 'Test Get-LEScreenshotsByAppExecution' {
            #$TestResult = Get-LEScreenshotsByAppExecution -TestRunId "TEST_VALUE" -AppExecutionId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
