...
Describe -tag 'PSLoginEnterprise' -name 'WorkloadApi' {
    ...
    Context 'Invoke-ConfigurationUpdateTestWorkloadStep' {
        It 'Test Invoke-ConfigurationUpdateTestWorkloadStep' {
            #$TestResult = Invoke-ConfigurationUpdateTestWorkloadStep -TestId "TEST_VALUE" -StepId "TEST_VALUE" -ConfigurationUpdateStepInApplicationGroupRequest "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
