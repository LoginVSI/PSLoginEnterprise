...
Describe -tag 'PSLoginEnterprise' -name 'PermissionApi' {
    Context 'Invoke-DataGetAllPermissions' {
        It 'Test Invoke-DataGetAllPermissions' {
            #$TestResult = Invoke-DataGetAllPermissions
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetPermissionsForCallingUser' {
        It 'Test Invoke-DataGetPermissionsForCallingUser' {
            #$TestResult = Invoke-DataGetPermissionsForCallingUser
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
