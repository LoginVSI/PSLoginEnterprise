...
Describe -tag 'PSLoginEnterprise' -name 'LdapConfigurationApi' {
    Context 'Invoke-ConfigurationCreateLdapConfig' {
        It 'Test Invoke-ConfigurationCreateLdapConfig' {
            #$TestResult = Invoke-ConfigurationCreateLdapConfig -LdapConfigModelUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationDeleteLdapConfig' {
        It 'Test Invoke-ConfigurationDeleteLdapConfig' {
            #$TestResult = Invoke-ConfigurationDeleteLdapConfig
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationGetLdapConfig' {
        It 'Test Invoke-ConfigurationGetLdapConfig' {
            #$TestResult = Invoke-ConfigurationGetLdapConfig
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationUpdateLdapConfig' {
        It 'Test Invoke-ConfigurationUpdateLdapConfig' {
            #$TestResult = Invoke-ConfigurationUpdateLdapConfig -LdapConfigModelUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
