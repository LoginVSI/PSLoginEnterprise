...
Describe -tag 'PSLoginEnterprise' -name 'ConnectionResourcesApi' {
    Context 'Invoke-ConfigurationGetConnectionResources' {
        It 'Test Invoke-ConfigurationGetConnectionResources' {
            #$TestResult = Invoke-ConfigurationGetConnectionResources -TestId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationUpdateConnectionResources' {
        It 'Test Invoke-ConfigurationUpdateConnectionResources' {
            #$TestResult = Invoke-ConfigurationUpdateConnectionResources -TestId "TEST_VALUE" -ConnectionResourcesUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
