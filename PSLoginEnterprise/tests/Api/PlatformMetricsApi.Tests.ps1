...
Describe -tag 'PSLoginEnterprise' -name 'PlatformMetricsApi' {
    Context 'Invoke-DataAddPlatformMetrics' {
        It 'Test Invoke-DataAddPlatformMetrics' {
            #$TestResult = Invoke-DataAddPlatformMetrics -PlatformMetric "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetPlatformMetrics' {
        It 'Test Invoke-DataGetPlatformMetrics' {
            #$TestResult = Invoke-DataGetPlatformMetrics -From "TEST_VALUE" -To "TEST_VALUE" -EnvironmentIds "TEST_VALUE" -MetricIds "TEST_VALUE" -MetricGroups "TEST_VALUE" -Instances "TEST_VALUE" -ComponentTypes "TEST_VALUE" -AggregationWindowEvery "TEST_VALUE" -AggregationWindowFn "TEST_VALUE" -GroupColumns "TEST_VALUE" -CustomTagsFilters "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
