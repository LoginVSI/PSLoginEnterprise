...
Describe -tag 'PSLoginEnterprise' -name 'LauncherApi' {
    Context 'Invoke-ConfigurationGetLauncher' {
        It 'Test Invoke-ConfigurationGetLauncher' {
            #$TestResult = Invoke-ConfigurationGetLauncher -LauncherName "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationGetLaunchers' {
        It 'Test Invoke-ConfigurationGetLaunchers' {
            #$TestResult = Invoke-ConfigurationGetLaunchers -Filter "TEST_VALUE" -OrderBy "TEST_VALUE" -Direction "TEST_VALUE" -Count "TEST_VALUE" -Offset "TEST_VALUE" -IncludeTotalCount "TEST_VALUE" -LocationIds "TEST_VALUE" -Online "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-ConfigurationUpdateLauncherLocation' {
        It 'Test Invoke-ConfigurationUpdateLauncherLocation' {
            #$TestResult = Invoke-ConfigurationUpdateLauncherLocation -LauncherName "TEST_VALUE" -LauncherLocationUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
