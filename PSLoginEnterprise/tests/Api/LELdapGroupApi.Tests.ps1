...
Describe -tag 'PSLoginEnterprise' -name 'LELELdapGroupApi' {
    Context 'New-LELdapGroup' {
        It 'Test New-LELdapGroup' {
            #$TestResult = New-LELdapGroup -LdapGroupCreate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-LEDeleteLdapGroup' {
        It 'Test Invoke-LEDeleteLdapGroup' {
            #$TestResult = Invoke-LEDeleteLdapGroup -LdapGroupId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEAllLdapGroups' {
        It 'Test Get-LEAllLdapGroups' {
            #$TestResult = Get-LEAllLdapGroups -Filter "TEST_VALUE" -Count "TEST_VALUE" -Offset "TEST_VALUE" -SortKey "TEST_VALUE" -Direction "TEST_VALUE" -IncludeTotalCount "TEST_VALUE" -Include "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LELdapGroupById' {
        It 'Test Get-LELdapGroupById' {
            #$TestResult = Get-LELdapGroupById -LdapGroupId "TEST_VALUE" -Include "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LELdapGroup' {
        It 'Test Update-LELdapGroup' {
            #$TestResult = Update-LELdapGroup -LdapGroupId "TEST_VALUE" -LdapGroupUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
