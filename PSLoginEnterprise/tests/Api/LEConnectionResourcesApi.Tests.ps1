...
Describe -tag 'PSLoginEnterprise' -name 'LELEConnectionResourcesApi' {
    Context 'Get-LEConnectionResources' {
        It 'Test Get-LEConnectionResources' {
            #$TestResult = Get-LEConnectionResources -TestId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LEConnectionResources' {
        It 'Test Update-LEConnectionResources' {
            #$TestResult = Update-LEConnectionResources -TestId "TEST_VALUE" -ConnectionResourcesUpdate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
