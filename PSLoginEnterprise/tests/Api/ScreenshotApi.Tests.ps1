...
Describe -tag 'PSLoginEnterprise' -name 'ScreenshotApi' {
    Context 'Invoke-DataGetScreenshotByAppExecution' {
        It 'Test Invoke-DataGetScreenshotByAppExecution' {
            #$TestResult = Invoke-DataGetScreenshotByAppExecution -TestRunId "TEST_VALUE" -AppExecutionId "TEST_VALUE" -ScreenshotId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetScreenshotByEvent' {
        It 'Test Invoke-DataGetScreenshotByEvent' {
            #$TestResult = Invoke-DataGetScreenshotByEvent -TestRunId "TEST_VALUE" -EventId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DataGetScreenshotsByAppExecution' {
        It 'Test Invoke-DataGetScreenshotsByAppExecution' {
            #$TestResult = Invoke-DataGetScreenshotsByAppExecution -TestRunId "TEST_VALUE" -AppExecutionId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
