...
Describe -tag 'PSLoginEnterprise' -name 'LELELdapConfigurationApi' {
    Context 'New-LELdapConfig' {
        It 'Test New-LELdapConfig' {
            #$TestResult = New-LELdapConfig -LdapConfigModel "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-LEDeleteLdapConfig' {
        It 'Test Invoke-LEDeleteLdapConfig' {
            #$TestResult = Invoke-LEDeleteLdapConfig
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LELdapConfig' {
        It 'Test Get-LELdapConfig' {
            #$TestResult = Get-LELdapConfig
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LELdapConfig' {
        It 'Test Update-LELdapConfig' {
            #$TestResult = Update-LELdapConfig -LdapConfigModel "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
