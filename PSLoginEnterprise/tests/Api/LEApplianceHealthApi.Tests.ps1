...
Describe -tag 'PSLoginEnterprise' -name 'LELEApplianceHealthApi' {
    Context 'Get-LEApplianceHealthAlertSettingsAsync' {
        It 'Test Get-LEApplianceHealthAlertSettingsAsync' {
            #$TestResult = Get-LEApplianceHealthAlertSettingsAsync
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEApplianceHealthMetricsAsync' {
        It 'Test Get-LEApplianceHealthMetricsAsync' {
            #$TestResult = Get-LEApplianceHealthMetricsAsync -From "TEST_VALUE" -To "TEST_VALUE" -MetricIds "TEST_VALUE" -AggregationWindowEvery "TEST_VALUE" -AggregationWindowFn "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LEApplianceHealthAlertSettingsAsync' {
        It 'Test Update-LEApplianceHealthAlertSettingsAsync' {
            #$TestResult = Update-LEApplianceHealthAlertSettingsAsync -ApplianceHealthAlertSettings "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
