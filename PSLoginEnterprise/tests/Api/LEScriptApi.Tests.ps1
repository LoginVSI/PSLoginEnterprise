...
Describe -tag 'PSLoginEnterprise' -name 'LELEScriptApi' {
    Context 'New-LEScript' {
        It 'Test New-LEScript' {
            #$TestResult = New-LEScript -ApplicationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-LEScript' {
        It 'Test Get-LEScript' {
            #$TestResult = Get-LEScript -ApplicationId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
