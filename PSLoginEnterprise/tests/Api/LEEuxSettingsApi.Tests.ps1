...
Describe -tag 'PSLoginEnterprise' -name 'LELEEuxSettingsApi' {
    Context 'Get-LEEuxSettings' {
        It 'Test Get-LEEuxSettings' {
            #$TestResult = Get-LEEuxSettings
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Update-LEEuxSettings' {
        It 'Test Update-LEEuxSettings' {
            #$TestResult = Update-LEEuxSettings -EuxSettings "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
