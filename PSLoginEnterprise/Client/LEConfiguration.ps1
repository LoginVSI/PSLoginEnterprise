...
Get the configuration object 'LEConfiguration'.
...
#>
function Get-LEConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "/publicApi";
    }
...
None
#>
function Set-LEConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-LEConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-LEConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-LEUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-LEConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-LEKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'LEConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-LEConfigurationHttpSigning{
