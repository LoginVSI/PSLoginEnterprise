# PSLoginEnterprise.PSLoginEnterprise\Api.PlatformMetricsApi

All URIs are relative to */publicApi*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-DataAddPlatformMetrics**](PlatformMetricsApi.md#Invoke-DataAddPlatformMetrics) | **POST** /v7/platform-metrics | Adds a collection of platform metrics for a specified environment.
[**Invoke-DataGetPlatformMetrics**](PlatformMetricsApi.md#Invoke-DataGetPlatformMetrics) | **GET** /v7/platform-metrics | Retrieves a collection of platform metrics based on the specified filters.


<a id="Invoke-DataAddPlatformMetrics"></a>
# **Invoke-DataAddPlatformMetrics**
> AddPlatformMetricsResult Invoke-DataAddPlatformMetrics<br>
...
# Adds a collection of platform metrics for a specified environment.
try {
    $Result = Invoke-DataAddPlatformMetrics -PlatformMetric $PlatformMetric
} catch {
    Write-Host ("Exception occurred when calling Invoke-DataAddPlatformMetrics: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="Invoke-DataGetPlatformMetrics"></a>
# **Invoke-DataGetPlatformMetrics**
> PlatformMetricSeries[] Invoke-DataGetPlatformMetrics<br>
...
# Retrieves a collection of platform metrics based on the specified filters.
try {
    $Result = Invoke-DataGetPlatformMetrics -From $From -To $To -EnvironmentIds $EnvironmentIds -MetricIds $MetricIds -MetricGroups $MetricGroups -Instances $Instances -ComponentTypes $ComponentTypes -AggregationWindowEvery $AggregationWindowEvery -AggregationWindowFn $AggregationWindowFn -GroupColumns $GroupColumns -CustomTagsFilters $CustomTagsFilters
} catch {
    Write-Host ("Exception occurred when calling Invoke-DataGetPlatformMetrics: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
