# PSLoginEnterprise.PSLoginEnterprise\Api.ApplianceHealthApi

All URIs are relative to */publicApi*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-DataGetApplianceHealthAlertSettingsAsync**](ApplianceHealthApi.md#Invoke-DataGetApplianceHealthAlertSettingsAsync) | **GET** /v7/appliance-health/settings | Retrieves the current appliance health alert settings.
[**Invoke-DataGetApplianceHealthMetricsAsync**](ApplianceHealthApi.md#Invoke-DataGetApplianceHealthMetricsAsync) | **GET** /v7/appliance-health | Retrieves a collection of appliance health metrics based on the specified filters.
[**Invoke-DataUpdateApplianceHealthAlertSettingsAsync**](ApplianceHealthApi.md#Invoke-DataUpdateApplianceHealthAlertSettingsAsync) | **PUT** /v7/appliance-health/settings | Updates the appliance health alert settings.


<a id="Invoke-DataGetApplianceHealthAlertSettingsAsync"></a>
# **Invoke-DataGetApplianceHealthAlertSettingsAsync**
> ApplianceHealthAlertSettings Invoke-DataGetApplianceHealthAlertSettingsAsync<br>
...
# Retrieves the current appliance health alert settings.
try {
    $Result = Invoke-DataGetApplianceHealthAlertSettingsAsync
} catch {
    Write-Host ("Exception occurred when calling Invoke-DataGetApplianceHealthAlertSettingsAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="Invoke-DataGetApplianceHealthMetricsAsync"></a>
# **Invoke-DataGetApplianceHealthMetricsAsync**
> ApplianceHealthMetricSeries[] Invoke-DataGetApplianceHealthMetricsAsync<br>
...
# Retrieves a collection of appliance health metrics based on the specified filters.
try {
    $Result = Invoke-DataGetApplianceHealthMetricsAsync -From $From -To $To -MetricIds $MetricIds -AggregationWindowEvery $AggregationWindowEvery -AggregationWindowFn $AggregationWindowFn
} catch {
    Write-Host ("Exception occurred when calling Invoke-DataGetApplianceHealthMetricsAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DataUpdateApplianceHealthAlertSettingsAsync"></a>
# **Invoke-DataUpdateApplianceHealthAlertSettingsAsync**
> void Invoke-DataUpdateApplianceHealthAlertSettingsAsync<br>
...
# Updates the appliance health alert settings.
try {
    $Result = Invoke-DataUpdateApplianceHealthAlertSettingsAsync -ApplianceHealthAlertSettings $ApplianceHealthAlertSettings
} catch {
    Write-Host ("Exception occurred when calling Invoke-DataUpdateApplianceHealthAlertSettingsAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
