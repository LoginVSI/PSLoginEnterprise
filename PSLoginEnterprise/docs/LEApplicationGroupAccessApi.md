...
# Get application groups by role ID
try {
    $Result = Get-LEApplicationGroupsByRole -RoleId $RoleId -OrderBy $OrderBy -Direction $Direction -Count $Count -Offset $Offset -IncludeTotalCount $IncludeTotalCount -Filter $Filter
} catch {
