...
function ConvertFrom-LEJsonToLoadTestRun {
    ...
    Process {
        ...
        $AllProperties = ("type", "state", "result", "rampUpCompleted", "activeSessionCount", "statisticsReady", "productVersion", "loginCounts", "engineCounts", "appExecutionCounts", "euxScore", "vsiMax", "comment", "id", "testId", "created", "started", "finished", "counter")
