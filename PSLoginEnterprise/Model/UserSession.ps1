...
function ConvertFrom-LEJsonToUserSession {
    ...
    Process {
        ...
        $AllProperties = ("id", "testRunId", "testId", "created", "loginState", "sessionState", "stateLastModified", "testType", "accountId", "launcherName", "loginStartTime", "loginEndTime", "sessionEndTime", "properties")
