...
function Initialize-LEWindowsApplication {
    [CmdletBinding()]
    Param (
...
function ConvertFrom-LEJsonToWindowsApplication {
    ...
    Process {
        ...
        $AllProperties = ("type", "commandLine", "workingDirectory", "mainWindowTitle", "mainProcessName", "id", "name", "description", "username", "created", "lastModified", "script", "timers", "takeScreenshots", "hasPassword")
