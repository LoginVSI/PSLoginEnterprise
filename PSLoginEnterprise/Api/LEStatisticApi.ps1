...
function Get-LEApplicationDiagnostics {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/application-diagnostics'
        if (!$TestId) {
...
function Get-LEContinuousTestDiagnostic {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/test-diagnostics'
        if (!$TestId) {
...
function Get-LEContinuousTestDiagnostics {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/test-diagnostics'
