...
function Get-LEEventsByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/test-runs/{testRunId}/app-executions/{appExecutionId}/events'
        if (!$TestRunId) {
...
function Get-LEEventsByTestRun {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/test-runs/{testRunId}/events'
        if (!$TestRunId) {
...
function Get-LEEventsByUserSession {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/test-runs/{testRunId}/user-sessions/{userSessionId}/events'
        if (!$TestRunId) {
