...
function New-LEAccount {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/accounts'
...
function New-LEAccounts {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/accounts/bulk'
...
function Invoke-LEDeleteAccount {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/accounts/{accountId}'
        if (!$AccountId) {
...
function Update-LEAccountEnabled {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/accounts/{accountId}/enabled'
        if (!$AccountId) {
...
function Update-LEAccountsEnabled {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/accounts/enabled'
