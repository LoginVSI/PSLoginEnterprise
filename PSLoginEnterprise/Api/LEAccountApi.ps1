...
function Invoke-LEDeleteAccount {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/accounts/{accountId}'
        if (!$AccountId) {
...
function Update-LEAccountEnabled {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/accounts/{accountId}/enabled'
        if (!$AccountId) {
...
function Update-LEAccountsEnabled {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/accounts/enabled'
