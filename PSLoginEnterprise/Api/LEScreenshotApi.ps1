...
function Get-LEScreenshotByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v7/test-runs/{testRunId}/app-executions/{appExecutionId}/screenshots/{screenshotId}'
        if (!$TestRunId) {
...
function Get-LEScreenshotByEvent {
    ...
    Process {
        ...
        $LocalVarUri = '/v7/test-runs/{testRunId}/events/{eventId}/screenshots'
        if (!$TestRunId) {
...
function Get-LEScreenshotsByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v7/test-runs/{testRunId}/app-executions/{appExecutionId}/screenshots'
        if (!$TestRunId) {
