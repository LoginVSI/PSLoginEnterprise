...
SystemEuxVersion
#>
function Get-LESystemEuxVersion {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-LESystemEuxVersion' | Write-Debug
        ...
        $LocalVarUri = '/v7-preview/system/eux-version'
...
function Get-LESystemVersions {
    ...
    Process {
        'Calling method: Get-LESystemVersions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7-preview/system/version'
