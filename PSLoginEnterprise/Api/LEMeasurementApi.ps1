...
function Get-LEMeasurements {
    ...
    Process {
        'Calling method: Get-LEMeasurements' | Write-Debug
        ...
        $LocalVarUri = '/v7-preview/test-runs/{testRunId}/measurements'
        if (!$TestRunId) {
            throw "Error! The required parameter `TestRunId` missing when calling getMeasurements."
        }
...
MeasurementResultSet
#>
function Get-LEMeasurementsByAppExecution {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-LEMeasurementsByAppExecution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7-preview/test-runs/{testRunId}/app-executions/{appExecutionId}/measurements'
        if (!$TestRunId) {
            throw "Error! The required parameter `TestRunId` missing when calling getMeasurementsByAppExecution."
        }
        $LocalVarUri = $LocalVarUri.replace('{testRunId}', [System.Web.HTTPUtility]::UrlEncode($TestRunId))
        if (!$AppExecutionId) {
            throw "Error! The required parameter `AppExecutionId` missing when calling getMeasurementsByAppExecution."
        }
...
MeasurementResultSet
#>
function Get-LEMeasurementsByUserSession {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-LEMeasurementsByUserSession' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7-preview/test-runs/{testRunId}/user-sessions/{userSessionId}/measurements'
        if (!$TestRunId) {
            throw "Error! The required parameter `TestRunId` missing when calling getMeasurementsByUserSession."
        }
        $LocalVarUri = $LocalVarUri.replace('{testRunId}', [System.Web.HTTPUtility]::UrlEncode($TestRunId))
        if (!$UserSessionId) {
            throw "Error! The required parameter `UserSessionId` missing when calling getMeasurementsByUserSession."
        }
