...
function Get-LEMeasurements {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/test-runs/{testRunId}/measurements'
        if (!$TestRunId) {
...
function Get-LEMeasurementsByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/test-runs/{testRunId}/app-executions/{appExecutionId}/measurements'
        if (!$TestRunId) {
...
function Get-LEMeasurementsByUserSession {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/test-runs/{testRunId}/user-sessions/{userSessionId}/measurements'
        if (!$TestRunId) {
