...
function New-LEReportConfiguration {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/report-configurations'
        if (!$TestId) {
...
function New-LEReportConfigurationThreshold {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/report-configurations/{configurationId}/thresholds'
        if (!$TestId) {
...
function Invoke-LEDeleteReportConfiguration {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/report-configurations/{configurationId}'
        if (!$TestId) {
...
function Invoke-LEDeleteReportConfigurationLogo {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/report-configurations/{configurationId}/logo'
        if (!$TestId) {
...
function Invoke-LEDeleteReportConfigurationThreshold {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/report-configurations/{configurationId}/thresholds/{thresholdId}'
        if (!$TestId) {
...
function Request-LEReport {
    ...
    Process {
        ...
        $LocalVarUri = '/v7-preview/tests/{testId}/report-configurations/{configurationId}/report-request'
        if (!$TestId) {
