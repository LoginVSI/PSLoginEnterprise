...
function New-LERole {
    ...
    Process {
        'Calling method: New-LERole' | Write-Debug
...
function Invoke-LEDeleteRole {
    ...
    Process {
        'Calling method: Invoke-LEDeleteRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling deleteRole."
        }
...
function Get-LEAllRoles {
    ...
    Process {
        'Calling method: Get-LEAllRoles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-LERoleById {
    ...
    Process {
        'Calling method: Get-LERoleById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-LERolesForCallingUser {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-LERolesForCallingUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-LERole {
    ...
    Process {
        'Calling method: Update-LERole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v7/auth/roles/{roleId}'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling updateRole."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
