...
function New-LETestWorkloadSteps {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/tests/{testId}/workload'
        if (!$TestId) {
...
function Invoke-LEDeleteTestWorkloadStep {
    ...
    Process {
        ...
        $LocalVarUri = '/v6/tests/{testId}/workload/{stepId}'
        if (!$TestId) {
...
function Update-LETestWorkloadStep {
    ...
    Process {
        ...
        if (!$ConfigurationUpdateTestWorkloadStepRequest) {
            throw "Error! The required parameter `ConfigurationUpdateTestWorkloadStepRequest` missing when calling updateTestWorkloadStep."
        }
