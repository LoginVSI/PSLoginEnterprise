# PSLoginEnterprise.PSLoginEnterprise\Api.AppExecutionApi

All URIs are relative to */publicApi*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-DataGetAppExecutions**](AppExecutionApi.md#Invoke-DataGetAppExecutions) | **GET** /v7/test-runs/{testRunId}/user-sessions/{userSessionId}/app-executions | Get paginated list of app-executions


<a id="Invoke-DataGetAppExecutions"></a>
