...
```powershell
$ProviderResultSetItemsInner = Initialize-LEPSLoginEnterpriseProviderResultSetItemsInner  -Type null `
 -Id null `
 -Name null `
 -Description null `
 -Environments null `
...
```powershell
$ProviderResultSetItemsInner | ConvertTo-JSON
```
