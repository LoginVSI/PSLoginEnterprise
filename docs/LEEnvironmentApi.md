...
# Get a list of environments
try {
    $Result = Get-LEEnvironments -Filter $Filter -OrderBy $OrderBy -Direction $Direction -Count $Count -Offset $Offset -IncludeTotalCount $IncludeTotalCount -Include $Include
} catch {
...
# Get tests by environment id
try {
    $Result = Get-LETestsByEnvironmentKey -Type $Type -EnvironmentId $EnvironmentId -Filter $Filter -OrderBy $OrderBy -Direction $Direction -Count $Count -Offset $Offset -IncludeTotalCount $IncludeTotalCount -Include $Include
} catch {
