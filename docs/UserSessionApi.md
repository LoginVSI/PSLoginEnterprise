# PSLoginEnterprise.PSLoginEnterprise\Api.UserSessionApi

All URIs are relative to */publicApi*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-DataGetUserSession**](UserSessionApi.md#Invoke-DataGetUserSession) | **GET** /v7/test-runs/{testRunId}/user-sessions/{userSessionId} | Get user-session by id
[**Invoke-DataGetUserSessions**](UserSessionApi.md#Invoke-DataGetUserSessions) | **GET** /v7/test-runs/{testRunId}/user-sessions | Get paginated list of user-sessions


<a id="Invoke-DataGetUserSession"></a>
...
<a id="Invoke-DataGetUserSessions"></a>
...
# Get paginated list of user-sessions
try {
    $Result = Invoke-DataGetUserSessions -TestRunId $TestRunId -Direction $Direction -Count $Count -Offset $Offset -IncludeTotalCount $IncludeTotalCount -From $From -To $To -FilterType $FilterType -Include $Include
} catch {
